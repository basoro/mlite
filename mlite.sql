...
INSERT INTO `mlite_modules` VALUES (1,'settings','9'),(2,'dashboard','0'),(3,'master','1'),(4,'pasien','2'),(5,'rawat_jalan','3'),(6,'kasir_rawat_jalan','4'),(7,'kepegawaian','5'),(8,'farmasi','6'),(9,'users','8'),(10,'modules','7'),(11,'rawat_inap','10'),(12,'igd','11'),(13,'dokter_ralan','12'),(14,'dokter_igd','13'),(15,'dokter_ranap','14'),(16,'apotek_ralan','15'),(17,'laboratorium','16'),(18,'radiologi','17'),(19,'anjungan','18'),(20,'api','19'),(21,'jkn_mobile_v2','20'),(22,'icd','21'),(23,'kasir_rawat_inap','22'),(24,'keuangan','23'),(25,'laporan','24'),(26,'pasien_galleries','25'),(27,'operasi','26'),(28,'presensi','27'),(29,'profil','28'),(30,'vclaim','29'),(31,'vedika','30'),(32,'manajemen','31'),(33,'wagateway','32'),(34,'website','33');
...
INSERT INTO `mlite_settings` VALUES (1,'settings','logo','uploads/settings/logo.png'),(2,'settings','nama_instansi','mLITE Indonesia'),(3,'settings','alamat','Jl. Perintis Kemerdekaan 45'),(4,'settings','kota','Barabai'),(5,'settings','propinsi','Kalimantan Selatan'),(6,'settings','nomor_telepon','0812345678'),(7,'settings','email','info@mlite.id'),(8,'settings','website','https://mlite.id'),(9,'settings','ppk_bpjs','010101'),(10,'settings','footer','Copyright {?=date(\"Y\")?} &copy; by drg. F. Basoro. All rights reserved.'),(11,'settings','homepage','main'),(12,'settings','wallpaper','uploads/settings/wallpaper.jpg'),(13,'settings','text_color','#ffffff'),(14,'settings','igd',''),(15,'settings','laboratorium',''),(16,'settings','pj_laboratorium',''),(17,'settings','radiologi',''),(18,'settings','pj_radiologi',''),(19,'settings','dokter_ralan_per_dokter','false'),(20,'settings','cekstatusbayar','false'),(21,'settings','ceklimit','false'),(22,'settings','notif_presensi','true'),(23,'settings','responsivevoice','false'),(24,'settings','BpjsApiUrl','https://new-api.bpjs-kesehatan.go.id/new-vclaim-rest/'),(25,'settings','BpjsConsID',''),(26,'settings','BpjsSecretKey',''),(27,'settings','BpjsUserKey',''),(28,'settings','timezone','America/Los_Angeles'),(29,'settings','theme','default'),(30,'settings','theme_admin','mlite'),(31,'settings','admin_mode','simple'),(32,'settings','input_kasir','tidak'),(33,'settings','editor','wysiwyg'),(34,'settings','version','2022-01-01 00:00:01'),(35,'settings','update_check','0'),(36,'settings','update_changelog',''),(37,'settings','update_version','0'),(38,'settings','license',''),(39,'farmasi','deporalan','-'),(40,'farmasi','igd','-'),(41,'farmasi','deporanap','-'),(42,'farmasi','gudang','-'),(43,'anjungan','display_poli',''),(44,'anjungan','carabayar',''),(45,'anjungan','antrian_loket','1'),(46,'anjungan','antrian_cs','2'),(47,'anjungan','panggil_loket','1'),(48,'anjungan','panggil_loket_nomor','1'),(49,'anjungan','panggil_cs','1'),(50,'anjungan','panggil_cs_nomor','1'),(51,'anjungan','panggil_cs','1'),(52,'anjungan','panggil_cs_nomor','1'),(53,'anjungan','text_anjungan','Running text anjungan pasien mandiri.....'),(54,'anjungan','text_loket','Running text display antrian loket.....'),(55,'anjungan','text_poli','Running text display antrian poliklinik.....'),(56,'anjungan','text_laboratorium','Running text display antrian laboratorium.....'),(57,'anjungan','text_apotek','Running text display antrian apotek.....'),(58,'anjungan','text_farmasi','Running text display antrian farmasi.....'),(59,'anjungan','vidio','G4im8_n0OoI'),(60,'api','apam_key','qtbexUAxzqO3M8dCOo2vDMFvgYjdUEdMLVo341'),(61,'api','apam_status_daftar','Terdaftar'),(62,'api','apam_status_dilayani','Anda siap dilayani'),(63,'api','apam_webappsurl','http://localhost/webapps/'),(64,'api','apam_normpetugas','000001,000002'),(65,'api','apam_limit','2'),(66,'api','apam_smtp_host','ssl://smtp.gmail.com'),(67,'api','apam_smtp_port','465'),(68,'api','apam_smtp_username',''),(69,'api','apam_smtp_password',''),(70,'api','apam_kdpj',''),(71,'api','apam_kdprop',''),(72,'api','apam_kdkab',''),(73,'api','apam_kdkec',''),(74,'api','duitku_merchantCode',''),(75,'api','duitku_merchantKey',''),(76,'api','duitku_paymentAmount',''),(77,'api','duitku_paymentMethod',''),(78,'api','duitku_productDetails',''),(79,'api','duitku_expiryPeriod',''),(80,'api','duitku_kdpj',''),(81,'jkn_mobile_v2','x_username','jkn'),(82,'jkn_mobile_v2','x_password','mobile'),(83,'jkn_mobile_v2','header_token','X-Token'),(84,'jkn_mobile_v2','header_username','X-Username'),(85,'jkn_mobile_v2','header_password','X-Password'),(86,'jkn_mobile_v2','BpjsConsID',''),(87,'jkn_mobile_v2','BpjsSecretKey',''),(88,'jkn_mobile_v2','BpjsUserKey',''),(89,'jkn_mobile_v2','BpjsAntrianUrl','https://apijkn-dev.bpjs-kesehatan.go.id/antreanrs_dev/'),(90,'jkn_mobile_v2','kd_pj_bpjs',''),(91,'jkn_mobile_v2','exclude_taskid',''),(92,'jkn_mobile_v2','display',''),(93,'jkn_mobile_v2','kdprop',''),(94,'jkn_mobile_v2','kdkab',''),(95,'jkn_mobile_v2','kdkec',''),(96,'jkn_mobile_v2','kdkel',''),(97,'jkn_mobile_v2','perusahaan_pasien',''),(98,'jkn_mobile_v2','suku_bangsa',''),(99,'jkn_mobile_v2','bahasa_pasien',''),(100,'jkn_mobile_v2','cacat_fisik',''),(101,'keuangan','jurnal_kasir','0'),(102,'keuangan','akun_kredit_pendaftaran',''),(103,'keuangan','akun_kredit_tindakan_ralan',''),(104,'keuangan','akun_kredit_obat_bhp',''),(105,'keuangan','akun_kredit_laboratorium',''),(106,'keuangan','akun_kredit_radiologi',''),(107,'keuangan','akun_kredit_tambahan_biaya',''),(108,'presensi','lat','-2.58'),(109,'presensi','lon','115.37'),(110,'presensi','distance','2'),(111,'presensi','helloworld','Jangan Lupa Bahagia; \nCara untuk memulai adalah berhenti berbicara dan mulai melakukan; \nWaktu yang hilang tidak akan pernah ditemukan lagi; \nKamu bisa membodohi semua orang, tetapi kamu tidak bisa membohongi pikiranmu; \nIni bukan tentang ide. Ini tentang mewujudkan ide; \nBekerja bukan hanya untuk mencari materi. Bekerja merupakan manfaat bagi banyak orang'),(112,'vedika','username',''),(113,'vedika','password',''),(114,'vedika','sep',''),(115,'vedika','skdp',''),(116,'vedika','operasi',''),(117,'manajemen','penjab_umum','UMU'),(118,'manajemen','penjab_bpjs','BPJ'),(119,'wagateway','waapiserver','https://mlite.id'),(120,'wagateway','waapitoken','-'),(121,'wagateway','waapiphonenumber','-'),(122,'website','perpage','5'),(123,'website','disqus',''),(124,'website','dateformat','M d, Y'),(125,'website','title','Berita Internal'),(126,'website','desc','... RS Masa Gitu ...'),(127,'website','latestPostsCount','5'),(128,'website','homepage_login','1'),(129,'website','homepage_logo','website/logo.png'),(130,'website','homepage_logo_icon','website/icon-logo.png'),(131,'website','homepage_slider_bg','website/slider-bg.jpg'),(132,'website','homepage_typewriter_1','Medic LITE Indonesia'),(133,'website','homepage_typewriter_2','We Care Your Health'),(134,'website','homepage_typewriter_3','We are Expert!'),(135,'website','homepage_gawat_darurat','To save life and limb, itu adalah moto kami dalam layanan Gawat Darurat'),(136,'website','homepage_rawat_jalan_1','8.00 – 18.00'),(137,'website','homepage_rawat_jalan_2','8.00 – 16.00'),(138,'website','homepage_rawat_jalan_3','8.00 – 13.00'),(139,'website','homepage_rawat_inap','Dengan 128 bed tersedia, 8 kamar VVIP, 24 Kelas 1, 56 Kelas 2 dan 50 Kelas 3'),(140,'website','homepage_motto','Melayani Dengan Hati'),(141,'website','homepage_about_title','MENGAPA MEMILIH KAMI'),(142,'website','homepage_about_content','<h2>Layanan Paripurna</h2>\r\nMemberi pelayanan kesehatan yang aman, bermutu, antidiskriminasi, dan efektif dengan mengutamakan kepentingan pasien sesuai dengan standar pelayanan Rumah Sakit.\r\n\r\nDengan Misi, Mendorong peningkatan kualitas kehidupan masyarakat Indonesia dengan menyediakan solusi bisnis kesehatan yang bernilai tambah dan mengutamakan prinsip kemanusiaan dan keselamatan.'),(143,'website','homepage_about_bg','website/about_03.jpg'),(144,'website','homepage_about_youtube','T0qagA4_eVQ'),(145,'website','homepage_about_11','Peralatan Digital'),(146,'website','homepage_about_12','website/clinic_01.jpg'),(147,'website','homepage_about_21','Ruang Operasi Higienis'),(148,'website','homepage_about_22','website/clinic_02.jpg'),(149,'website','homepage_about_31','Spesialis Dibidangnya'),(150,'website','homepage_about_32','website/clinic_03.jpg'),(151,'website','homepage_about_41','Layanan Paripurna'),(152,'website','homepage_about_42','website/clinic_01.jpg'),(153,'website','homepage_services_11','FASILITAS PREMIUM'),(154,'website','homepage_services_12','Untuk memastikan bahwa Anda diberi perawatan terbaik'),(155,'website','homepage_services_13','website/service-icon1.png'),(156,'website','homepage_services_14','Terbaik Dibidangnya'),(157,'website','homepage_services_21','LABORATORIUM'),(158,'website','homepage_services_22','Alat laboratorium terbaik untuk ketepatan diagnosa'),(159,'website','homepage_services_23','website/service-icon2.png'),(160,'website','homepage_services_24','Tekhnologi Terkini'),(161,'website','homepage_services_31','DOKTER SPESIALIS'),(162,'website','homepage_services_32','Dilayani 35 Dokter Spesialis dan Sub Spesialis'),(163,'website','homepage_services_33','website/service-icon3.png'),(164,'website','homepage_services_34','Akurat & Rendah Radiasi'),(165,'website','homepage_services_41','PERAWATAN ANAK'),(166,'website','homepage_services_42','Deteksi dini dan pelayanan tumbuh kembang anak'),(167,'website','homepage_services_43','website/service-icon4.png'),(168,'website','homepage_services_44','Untuk Buah Hati'),(169,'website','homepage_services_51','LAYANAN FARMASI'),(170,'website','homepage_services_52','Memastikan ketepatan indikasi, aturan dan dosis obat'),(171,'website','homepage_services_53','website/service-icon5.png'),(172,'website','homepage_services_54','Tepat & Cepat'),(173,'website','homepage_services_61','BANK DARAH'),(174,'website','homepage_services_62','Menjamin ketersediaan darah untuk transfusi yang aman'),(175,'website','homepage_services_63','website/service-icon1.png'),(176,'website','homepage_services_64','Aman dan Nyaman'),(177,'website','homepage_footer_about','Rumah Sakit Pemerintah tipe C dengan layanan terdepan menggunakan tekhnologi terkini.'),(178,'website','homepage_footer_informasi_11','Jadwal Dokter'),(179,'website','homepage_footer_informasi_12','http://localhost/webapps/jadwal.php'),(180,'website','homepage_footer_informasi_21','Ketersediaan Tempat Tidur'),(181,'website','homepage_footer_informasi_22','http://localhost/webapps/bed5.php'),(182,'website','homepage_footer_informasi_31','Display Antrian'),(183,'website','homepage_footer_informasi_32','http://localhost/webapps/antrian.php'),(184,'website','homepage_sosmed_facebook','basoro'),(185,'website','homepage_sosmed_youtube','basoro'),(186,'website','homepage_sosmed_instagram','basoro');
...
INSERT INTO `mlite_users` VALUES (1,'admin','Administrator','Admin ganteng baik hati, suka menabung dan tidak sombong.','$2y$10$pgRnDiukCbiYVqsamMM3ROWViSRqbyCCL33N8.ykBKZx0dlplXe9i','avatar627784eb5edde.png','info@mlite.id','admin','','all');
...
-- Dump completed on 2022-05-08 17:08:49

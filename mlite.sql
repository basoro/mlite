...
--
-- Host: localhost:3306
-- Generation Time: Apr 17, 2022 at 06:34 PM
...
--
-- Table structure for table `mlite_blog`
--
...
--
-- Table structure for table `mlite_blog_tags`
--
...
--
-- Table structure for table `mlite_blog_tags_relationship`
--
...
(2, 'settings', 'nama_instansi', 'RS Masa Kini'),
...
(7, 'settings', 'email', 'info@mlite.org'),
(8, 'settings', 'website', 'https://mlite.org'),
...
(12, 'settings', 'igd', '-'),
(13, 'settings', 'laboratorium', '-'),
(14, 'settings', 'pj_laboratorium', 'DR001'),
(15, 'settings', 'radiologi', '-'),
(16, 'settings', 'pj_radiologi', 'DR001'),
(17, 'settings', 'dokter_ralan_per_dokter', 'false'),
(18, 'settings', 'cekstatusbayar', 'false'),
(19, 'settings', 'ceklimit', 'false'),
(20, 'settings', 'notif_presensi', 'true'),
(21, 'settings', 'responsivevoice', 'false'),
(22, 'settings', 'waapitoken', '-'),
(23, 'settings', 'waapiphonenumber', '-'),
(24, 'settings', 'BpjsApiUrl', 'https://new-api.bpjs-kesehatan.go.id:8080/new-vclaim-rest/'),
(25, 'settings', 'BpjsConsID', ''),
(26, 'settings', 'BpjsSecretKey', ''),
(27, 'settings', 'BpjsUserKey', ''),
(28, 'settings', 'vClaimVersion', '1'),
(29, 'settings', 'timezone', 'America/Los_Angeles'),
(30, 'settings', 'theme', 'default'),
(31, 'settings', 'theme_admin', 'flatly'),
(32, 'settings', 'admin_mode', 'simple'),
(33, 'settings', 'input_kasir', 'tidak'),
(34, 'settings', 'editor', 'wysiwyg'),
(35, 'settings', 'version', '2022-01-01 00:00:01'),
(36, 'settings', 'update_check', '0'),
(37, 'settings', 'update_changelog', ''),
(38, 'settings', 'update_version', '0'),
(39, 'settings', 'license', ''),
(40, 'farmasi', 'deporalan', '-'),
(41, 'farmasi', 'igd', '-'),
(42, 'farmasi', 'deporanap', '-'),
(43, 'farmasi', 'gudang', '-'),
(44, 'anjungan', 'display_poli', ''),
(45, 'anjungan', 'carabayar', ''),
(46, 'anjungan', 'antrian_loket', '1'),
(47, 'anjungan', 'antrian_cs', '2'),
(48, 'anjungan', 'panggil_loket', '1'),
(49, 'anjungan', 'panggil_loket_nomor', '1'),
(50, 'anjungan', 'panggil_cs', '1'),
(51, 'anjungan', 'panggil_cs_nomor', '1'),
(52, 'anjungan', 'panggil_cs', '1'),
(53, 'anjungan', 'panggil_cs_nomor', '1'),
(54, 'anjungan', 'text_anjungan', 'Running text anjungan pasien mandiri.....'),
(55, 'anjungan', 'text_loket', 'Running text display antrian loket.....'),
(56, 'anjungan', 'text_poli', 'Running text display antrian poliklinik.....'),
(57, 'anjungan', 'text_laboratorium', 'Running text display antrian laboratorium.....'),
(58, 'anjungan', 'text_apotek', 'Running text display antrian apotek.....'),
(59, 'anjungan', 'vidio', 'G4im8_n0OoI'),
(60, 'api', 'apam_key', 'qtbexUAxzqO3M8dCOo2vDMFvgYjdUEdMLVo341'),
(61, 'api', 'apam_status_daftar', 'Terdaftar'),
(62, 'api', 'apam_status_dilayani', 'Anda siap dilayani'),
(63, 'api', 'apam_webappsurl', 'http://localhost/webapps/'),
(64, 'api', 'apam_normpetugas', '000001,000002'),
(65, 'api', 'apam_limit', '2'),
(66, 'api', 'apam_smtp_host', 'ssl://smtp.gmail.com'),
(67, 'api', 'apam_smtp_port', '465'),
(68, 'api', 'apam_smtp_username', ''),
(69, 'api', 'apam_smtp_password', ''),
(70, 'api', 'apam_kdpj', ''),
(71, 'api', 'apam_kdprop', ''),
(72, 'api', 'apam_kdkab', ''),
(73, 'api', 'apam_kdkec', ''),
(74, 'api', 'duitku_merchantCode', ''),
(75, 'api', 'duitku_merchantKey', ''),
(76, 'api', 'duitku_paymentAmount', ''),
(77, 'api', 'duitku_paymentMethod', ''),
(78, 'api', 'duitku_productDetails', ''),
(79, 'api', 'duitku_expiryPeriod', ''),
(80, 'api', 'duitku_kdpj', ''),
(81, 'jkn_mobile_v2', 'x_username', 'jkn'),
(82, 'jkn_mobile_v2', 'x_password', 'mobile'),
(83, 'jkn_mobile_v2', 'header_token', 'X-Token'),
(84, 'jkn_mobile_v2', 'header_username', 'X-Username'),
(85, 'jkn_mobile_v2', 'header_password', 'X-Password'),
(86, 'jkn_mobile_v2', 'BpjsConsID', ''),
(87, 'jkn_mobile_v2', 'BpjsSecretKey', ''),
(88, 'jkn_mobile_v2', 'BpjsUserKey', ''),
(89, 'jkn_mobile_v2', 'BpjsAntrianUrl', 'https://dvlp.bpjs-kesehatan.go.id:8887/arsws/rest/v1/'),
(90, 'jkn_mobile_v2', 'kd_pj_bpjs', ''),
(91, 'jkn_mobile_v2', 'exclude_taskid', ''),
(92, 'jkn_mobile_v2', 'display', ''),
(93, 'jkn_mobile_v2', 'kdprop', ''),
(94, 'jkn_mobile_v2', 'kdkab', ''),
(95, 'jkn_mobile_v2', 'kdkec', ''),
(96, 'jkn_mobile_v2', 'kdkel', ''),
(97, 'jkn_mobile_v2', 'perusahaan_pasien', ''),
(98, 'jkn_mobile_v2', 'suku_bangsa', ''),
(99, 'jkn_mobile_v2', 'bahasa_pasien', ''),
(100, 'jkn_mobile_v2', 'cacat_fisik', ''),
(101, 'vedika', 'username', ''),
(102, 'vedika', 'password', ''),
(103, 'vedika', 'sep', ''),
(104, 'vedika', 'skdp', ''),
(105, 'vedika', 'operasi', ''),
(106, 'manajemen', 'penjab_umum', 'UMU'),
(107, 'manajemen', 'penjab_bpjs', 'BPJ'),
(108, 'keuangan', 'jurnal_kasir', '0'),
(109, 'keuangan', 'akun_kredit_pendaftaran', ''),
(110, 'keuangan', 'akun_kredit_tindakan_ralan', ''),
...
(115, 'blog', 'perpage', '5'),
(116, 'blog', 'disqus', ''),
(117, 'blog', 'dateformat', 'M d, Y'),
(118, 'blog', 'title', 'Blog'),
(119, 'blog', 'desc', '... RS Masa Gitu ...'),
(120, 'blog', 'latestPostsCount', '5'),
(121, 'blog', 'homepage_login', '1'),
(122, 'blog', 'homepage_logo', 'website/logo.png'),
(123, 'blog', 'homepage_logo_icon', 'website/icon-logo.png'),
(124, 'blog', 'homepage_slider_bg', 'website/slider-bg.jpg'),
(125, 'blog', 'homepage_typewriter_1', 'Welcome to RS Khanza'),
(126, 'blog', 'homepage_typewriter_2', 'We Care Your Health'),
(127, 'blog', 'homepage_typewriter_3', 'We are Expert!'),
(128, 'blog', 'homepage_gawat_darurat', 'To save life and limb, itu adalah moto kami dalam layanan Gawat Darurat'),
(129, 'blog', 'homepage_rawat_jalan_1', '8.00 – 18.00'),
(130, 'blog', 'homepage_rawat_jalan_2', '8.00 – 16.00'),
(131, 'blog', 'homepage_rawat_jalan_3', '8.00 – 13.00'),
(132, 'blog', 'homepage_rawat_inap', 'Dengan 128 bed tersedia, 8 kamar VVIP, 24 Kelas 1, 56 Kelas 2 dan 50 Kelas 3'),
(133, 'blog', 'homepage_motto', 'Melayani Dengan Hati'),
(134, 'blog', 'homepage_about_title', 'MENGAPA MEMILIH KAMI'),
(135, 'blog', 'homepage_about_content', '<h2>Layanan Paripurna</h2>\r\nMemberi pelayanan kesehatan yang aman, bermutu, antidiskriminasi, dan efektif dengan mengutamakan kepentingan pasien sesuai dengan standar pelayanan Rumah Sakit.\r\n\r\nDengan Misi, Mendorong peningkatan kualitas kehidupan masyarakat Indonesia dengan menyediakan solusi bisnis kesehatan yang bernilai tambah dan mengutamakan prinsip kemanusiaan dan keselamatan.'),
(136, 'blog', 'homepage_about_bg', 'website/about_03.jpg'),
(137, 'blog', 'homepage_about_youtube', 'T0qagA4_eVQ'),
(138, 'blog', 'homepage_about_11', 'Peralatan Digital'),
(139, 'blog', 'homepage_about_12', 'website/clinic_01.jpg'),
(140, 'blog', 'homepage_about_21', 'Ruang Operasi Higienis'),
(141, 'blog', 'homepage_about_22', 'website/clinic_02.jpg'),
(142, 'blog', 'homepage_about_31', 'Spesialis Dibidangnya'),
(143, 'blog', 'homepage_about_32', 'website/clinic_03.jpg'),
(144, 'blog', 'homepage_about_41', 'Layanan Paripurna'),
(145, 'blog', 'homepage_about_42', 'website/clinic_01.jpg'),
(146, 'blog', 'homepage_services_11', 'FASILITAS PREMIUM'),
(147, 'blog', 'homepage_services_12', 'Untuk memastikan bahwa Anda diberi perawatan terbaik'),
(148, 'blog', 'homepage_services_13', 'website/service-icon1.png'),
(149, 'blog', 'homepage_services_14', 'Terbaik Dibidangnya'),
(150, 'blog', 'homepage_services_21', 'LABORATORIUM'),
(151, 'blog', 'homepage_services_22', 'Alat laboratorium terbaik untuk ketepatan diagnosa'),
(152, 'blog', 'homepage_services_23', 'website/service-icon2.png'),
(153, 'blog', 'homepage_services_24', 'Tekhnologi Terkini'),
(154, 'blog', 'homepage_services_31', 'DOKTER SPESIALIS'),
(155, 'blog', 'homepage_services_32', 'Dilayani 35 Dokter Spesialis dan Sub Spesialis'),
(156, 'blog', 'homepage_services_33', 'website/service-icon3.png'),
(157, 'blog', 'homepage_services_34', 'Akurat & Rendah Radiasi'),
(158, 'blog', 'homepage_services_41', 'PERAWATAN ANAK'),
(159, 'blog', 'homepage_services_42', 'Deteksi dini dan pelayanan tumbuh kembang anak'),
(160, 'blog', 'homepage_services_43', 'website/service-icon4.png'),
(161, 'blog', 'homepage_services_44', 'Untuk Buah Hati'),
(162, 'blog', 'homepage_services_51', 'LAYANAN FARMASI'),
(163, 'blog', 'homepage_services_52', 'Memastikan ketepatan indikasi, aturan dan dosis obat'),
(164, 'blog', 'homepage_services_53', 'website/service-icon5.png'),
(165, 'blog', 'homepage_services_54', 'Tepat & Cepat'),
(166, 'blog', 'homepage_services_61', 'BANK DARAH'),
(167, 'blog', 'homepage_services_62', 'Menjamin ketersediaan darah untuk transfusi yang aman'),
(168, 'blog', 'homepage_services_63', 'website/service-icon1.png'),
(169, 'blog', 'homepage_services_64', 'Aman dan Nyaman'),
(170, 'blog', 'homepage_footer_about', 'Rumah Sakit Pemerintah tipe C dengan layanan terdepan menggunakan tekhnologi terkini.'),
(171, 'blog', 'homepage_footer_informasi_11', 'Jadwal Dokter'),
(172, 'blog', 'homepage_footer_informasi_12', 'http://localhost/webapps/jadwal.php'),
(173, 'blog', 'homepage_footer_informasi_21', 'Ketersediaan Tempat Tidur'),
(174, 'blog', 'homepage_footer_informasi_22', 'http://localhost/webapps/bed5.php'),
(175, 'blog', 'homepage_footer_informasi_31', 'Display Antrian'),
(176, 'blog', 'homepage_footer_informasi_32', 'http://localhost/webapps/antrian.php'),
(177, 'blog', 'homepage_sosmed_facebook', 'basoro'),
(178, 'blog', 'homepage_sosmed_youtube', 'basoro'),
(179, 'blog', 'homepage_sosmed_instagram', 'basoro');
...
(1, 'admin', 'Administrator', 'Admin ganteng baik hati, suka menabung dan tidak sombong.', '$2y$10$pgRnDiukCbiYVqsamMM3ROWViSRqbyCCL33N8.ykBKZx0dlplXe9i', 'avatar625c079931ac9.png', 'admin@basoro.org', 'admin', '', 'all');
...
--
-- Indexes for table `mlite_blog`
--
ALTER TABLE `mlite_blog`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mlite_blog_tags`
--
ALTER TABLE `mlite_blog_tags`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mlite_blog_tags_relationship`
--
ALTER TABLE `mlite_blog_tags_relationship`
...
--
-- AUTO_INCREMENT for table `mlite_blog`
--
ALTER TABLE `mlite_blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mlite_blog_tags`
--
ALTER TABLE `mlite_blog_tags`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `mlite_blog_tags_relationship`
--
ALTER TABLE `mlite_blog_tags_relationship`

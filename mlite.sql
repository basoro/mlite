...
INSERT INTO `mlite_modules` VALUES (1,'settings','9'),(2,'dashboard','0'),(3,'master','1'),(4,'pasien','2'),(5,'rawat_jalan','3'),(6,'kasir_rawat_jalan','4'),(7,'kepegawaian','5'),(8,'farmasi','6'),(9,'users','8'),(10,'modules','7'),(11,'igd','10'),(12,'rawat_inap','11'),(13,'dokter_ralan','12'),(14,'dokter_igd','13'),(15,'dokter_ranap','14'),(16,'laboratorium','15'),(17,'radiologi','16'),(18,'apotek_ralan','17'),(19,'pasien_galleries','18'),(20,'presensi','19'),(21,'profil','20'),(22,'api','21'),(23,'anjungan','22'),(24,'kasir_rawat_inap','23'),(25,'icd','24'),(26,'jkn_mobile_v2','25'),(27,'keuangan','26'),(28,'laporan','27'),(29,'manajemen','28'),(30,'operasi','29'),(31,'vclaim','30'),(32,'vedika','31'),(33,'wagateway','32'),(34,'website','33');
...
--
-- Dumping data for table `mlite_news`
--

LOCK TABLES `mlite_news` WRITE;
/*!40000 ALTER TABLE `mlite_news` DISABLE KEYS */;
/*!40000 ALTER TABLE `mlite_news` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mlite_news_tags`
--

LOCK TABLES `mlite_news_tags` WRITE;
/*!40000 ALTER TABLE `mlite_news_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `mlite_news_tags` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `mlite_news_tags_relationship` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `mlite_news_tags_relationship_ibfk_1` FOREIGN KEY (`news_id`) REFERENCES `mlite_news` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `mlite_news_tags_relationship_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `mlite_news_tags` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mlite_news_tags_relationship`
--

LOCK TABLES `mlite_news_tags_relationship` WRITE;
/*!40000 ALTER TABLE `mlite_news_tags_relationship` DISABLE KEYS */;
/*!40000 ALTER TABLE `mlite_news_tags_relationship` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mlite_settings` VALUES (1,'settings','logo','uploads/settings/logo.png'),(2,'settings','nama_instansi','mLITE Indonesia'),(3,'settings','alamat','Jl. Perintis Kemerdekaan 45'),(4,'settings','kota','Barabai'),(5,'settings','propinsi','Kalimantan Selatan'),(6,'settings','nomor_telepon','0812345678'),(7,'settings','email','info@mlite.id'),(8,'settings','website','https://mlite.id'),(9,'settings','ppk_bpjs','010101'),(10,'settings','footer','Copyright {?=date(\"Y\")?} &copy; by drg. F. Basoro. All rights reserved.'),(11,'settings','homepage','main'),(12,'settings','wallpaper','uploads/settings/wallpaper.jpg'),(13,'settings','text_color','#ffffff'),(14,'settings','igd',''),(15,'settings','laboratorium',''),(16,'settings','pj_laboratorium',''),(17,'settings','radiologi',''),(18,'settings','pj_radiologi',''),(19,'settings','dokter_ralan_per_dokter','false'),(20,'settings','cekstatusbayar','false'),(21,'settings','ceklimit','false'),(22,'settings','notif_presensi','true'),(23,'settings','responsivevoice','false'),(24,'settings','waapiserver','https://mlite.id'),(25,'settings','waapitoken','-'),(26,'settings','waapiphonenumber','-'),(27,'settings','waapiwebhook','https://mlite.id/webhhok.php'),(28,'settings','BpjsApiUrl','https://new-api.bpjs-kesehatan.go.id/new-vclaim-rest/'),(29,'settings','BpjsConsID',''),(30,'settings','BpjsSecretKey',''),(31,'settings','BpjsUserKey',''),(32,'settings','vClaimVersion','1'),(33,'settings','timezone','Asia/Makassar'),(34,'settings','theme','default'),(35,'settings','theme_admin','mlite'),(36,'settings','admin_mode','simple'),(37,'settings','input_kasir','tidak'),(38,'settings','editor','wysiwyg'),(39,'settings','version','2022-01-01 00:00:01'),(40,'settings','update_check','0'),(41,'settings','update_changelog',''),(42,'settings','update_version','0'),(43,'settings','license',''),(44,'farmasi','deporalan','-'),(45,'farmasi','igd','-'),(46,'farmasi','deporanap','-'),(47,'farmasi','gudang','-'),(48,'presensi','lat','-2.58'),(49,'presensi','lon','115.37'),(50,'presensi','distance','2'),(51,'presensi','helloworld','Jangan Lupa Bahagia; \nCara untuk memulai adalah berhenti berbicara dan mulai melakukan; \nWaktu yang hilang tidak akan pernah ditemukan lagi; \nKamu bisa membodohi semua orang, tetapi kamu tidak bisa membohongi pikiranmu; \nIni bukan tentang ide. Ini tentang mewujudkan ide; \nBekerja bukan hanya untuk mencari materi. Bekerja merupakan manfaat bagi banyak orang'),(52,'api','apam_key','qtbexUAxzqO3M8dCOo2vDMFvgYjdUEdMLVo341'),(53,'api','apam_status_daftar','Terdaftar'),(54,'api','apam_status_dilayani','Anda siap dilayani'),(55,'api','apam_webappsurl','http://localhost/webapps/'),(56,'api','apam_normpetugas','000001,000002'),(57,'api','apam_limit','2'),(58,'api','apam_smtp_host','ssl://smtp.gmail.com'),(59,'api','apam_smtp_port','465'),(60,'api','apam_smtp_username',''),(61,'api','apam_smtp_password',''),(62,'api','apam_kdpj',''),(63,'api','apam_kdprop',''),(64,'api','apam_kdkab',''),(65,'api','apam_kdkec',''),(66,'api','duitku_merchantCode',''),(67,'api','duitku_merchantKey',''),(68,'api','duitku_paymentAmount',''),(69,'api','duitku_paymentMethod',''),(70,'api','duitku_productDetails',''),(71,'api','duitku_expiryPeriod',''),(72,'api','duitku_kdpj',''),(73,'anjungan','display_poli',''),(74,'anjungan','carabayar',''),(75,'anjungan','antrian_loket','1'),(76,'anjungan','antrian_cs','2'),(77,'anjungan','panggil_loket','1'),(78,'anjungan','panggil_loket_nomor','1'),(79,'anjungan','panggil_cs','1'),(80,'anjungan','panggil_cs_nomor','1'),(81,'anjungan','panggil_cs','1'),(82,'anjungan','panggil_cs_nomor','1'),(83,'anjungan','text_anjungan','Running text anjungan pasien mandiri.....'),(84,'anjungan','text_loket','Running text display antrian loket.....'),(85,'anjungan','text_poli','Running text display antrian poliklinik.....'),(86,'anjungan','text_laboratorium','Running text display antrian laboratorium.....'),(87,'anjungan','text_apotek','Running text display antrian apotek.....'),(88,'anjungan','text_farmasi','Running text display antrian farmasi.....'),(89,'anjungan','vidio','G4im8_n0OoI'),(90,'jkn_mobile_v2','x_username','jkn'),(91,'jkn_mobile_v2','x_password','mobile'),(92,'jkn_mobile_v2','header_token','X-Token'),(93,'jkn_mobile_v2','header_username','X-Username'),(94,'jkn_mobile_v2','header_password','X-Password'),(95,'jkn_mobile_v2','BpjsConsID',''),(96,'jkn_mobile_v2','BpjsSecretKey',''),(97,'jkn_mobile_v2','BpjsUserKey',''),(98,'jkn_mobile_v2','BpjsAntrianUrl','https://apijkn-dev.bpjs-kesehatan.go.id/antreanrs_dev/'),(99,'jkn_mobile_v2','kd_pj_bpjs',''),(100,'jkn_mobile_v2','exclude_taskid',''),(101,'jkn_mobile_v2','display',''),(102,'jkn_mobile_v2','kdprop',''),(103,'jkn_mobile_v2','kdkab',''),(104,'jkn_mobile_v2','kdkec',''),(105,'jkn_mobile_v2','kdkel',''),(106,'jkn_mobile_v2','perusahaan_pasien',''),(107,'jkn_mobile_v2','suku_bangsa',''),(108,'jkn_mobile_v2','bahasa_pasien',''),(109,'jkn_mobile_v2','cacat_fisik',''),(110,'keuangan','jurnal_kasir','0'),(111,'keuangan','akun_kredit_pendaftaran',''),(112,'keuangan','akun_kredit_tindakan_ralan',''),(113,'keuangan','akun_kredit_obat_bhp',''),(114,'keuangan','akun_kredit_laboratorium',''),(115,'keuangan','akun_kredit_radiologi',''),(116,'keuangan','akun_kredit_tambahan_biaya',''),(117,'manajemen','penjab_umum','UMU'),(118,'manajemen','penjab_bpjs','BPJ'),(119,'vedika','username',''),(120,'vedika','password',''),(121,'vedika','sep',''),(122,'vedika','skdp',''),(123,'vedika','operasi',''),(124,'website','perpage','5'),(125,'website','disqus',''),(126,'website','dateformat','M d, Y'),(127,'website','title','Berita Internal'),(128,'website','desc','... RS Masa Gitu ...'),(129,'website','latestPostsCount','5'),(130,'website','homepage_login','1'),(131,'website','homepage_logo','website/logo.png'),(132,'website','homepage_logo_icon','website/icon-logo.png'),(133,'website','homepage_slider_bg','website/slider-bg.jpg'),(134,'website','homepage_typewriter_1','Medic LITE Indonesia'),(135,'website','homepage_typewriter_2','We Care Your Health'),(136,'website','homepage_typewriter_3','We are Expert!'),(137,'website','homepage_gawat_darurat','To save life and limb, itu adalah moto kami dalam layanan Gawat Darurat'),(138,'website','homepage_rawat_jalan_1','8.00 – 18.00'),(139,'website','homepage_rawat_jalan_2','8.00 – 16.00'),(140,'website','homepage_rawat_jalan_3','8.00 – 13.00'),(141,'website','homepage_rawat_inap','Dengan 128 bed tersedia, 8 kamar VVIP, 24 Kelas 1, 56 Kelas 2 dan 50 Kelas 3'),(142,'website','homepage_motto','Melayani Dengan Hati'),(143,'website','homepage_about_title','MENGAPA MEMILIH KAMI'),(144,'website','homepage_about_content','<h2>Layanan Paripurna</h2>\r\nMemberi pelayanan kesehatan yang aman, bermutu, antidiskriminasi, dan efektif dengan mengutamakan kepentingan pasien sesuai dengan standar pelayanan Rumah Sakit.\r\n\r\nDengan Misi, Mendorong peningkatan kualitas kehidupan masyarakat Indonesia dengan menyediakan solusi bisnis kesehatan yang bernilai tambah dan mengutamakan prinsip kemanusiaan dan keselamatan.'),(145,'website','homepage_about_bg','website/about_03.jpg'),(146,'website','homepage_about_youtube','T0qagA4_eVQ'),(147,'website','homepage_about_11','Peralatan Digital'),(148,'website','homepage_about_12','website/clinic_01.jpg'),(149,'website','homepage_about_21','Ruang Operasi Higienis'),(150,'website','homepage_about_22','website/clinic_02.jpg'),(151,'website','homepage_about_31','Spesialis Dibidangnya'),(152,'website','homepage_about_32','website/clinic_03.jpg'),(153,'website','homepage_about_41','Layanan Paripurna'),(154,'website','homepage_about_42','website/clinic_01.jpg'),(155,'website','homepage_services_11','FASILITAS PREMIUM'),(156,'website','homepage_services_12','Untuk memastikan bahwa Anda diberi perawatan terbaik'),(157,'website','homepage_services_13','website/service-icon1.png'),(158,'website','homepage_services_14','Terbaik Dibidangnya'),(159,'website','homepage_services_21','LABORATORIUM'),(160,'website','homepage_services_22','Alat laboratorium terbaik untuk ketepatan diagnosa'),(161,'website','homepage_services_23','website/service-icon2.png'),(162,'website','homepage_services_24','Tekhnologi Terkini'),(163,'website','homepage_services_31','DOKTER SPESIALIS'),(164,'website','homepage_services_32','Dilayani 35 Dokter Spesialis dan Sub Spesialis'),(165,'website','homepage_services_33','website/service-icon3.png'),(166,'website','homepage_services_34','Akurat & Rendah Radiasi'),(167,'website','homepage_services_41','PERAWATAN ANAK'),(168,'website','homepage_services_42','Deteksi dini dan pelayanan tumbuh kembang anak'),(169,'website','homepage_services_43','website/service-icon4.png'),(170,'website','homepage_services_44','Untuk Buah Hati'),(171,'website','homepage_services_51','LAYANAN FARMASI'),(172,'website','homepage_services_52','Memastikan ketepatan indikasi, aturan dan dosis obat'),(173,'website','homepage_services_53','website/service-icon5.png'),(174,'website','homepage_services_54','Tepat & Cepat'),(175,'website','homepage_services_61','BANK DARAH'),(176,'website','homepage_services_62','Menjamin ketersediaan darah untuk transfusi yang aman'),(177,'website','homepage_services_63','website/service-icon1.png'),(178,'website','homepage_services_64','Aman dan Nyaman'),(179,'website','homepage_footer_about','Rumah Sakit Pemerintah tipe C dengan layanan terdepan menggunakan tekhnologi terkini.'),(180,'website','homepage_footer_informasi_11','Jadwal Dokter'),(181,'website','homepage_footer_informasi_12','http://localhost/webapps/jadwal.php'),(182,'website','homepage_footer_informasi_21','Ketersediaan Tempat Tidur'),(183,'website','homepage_footer_informasi_22','http://localhost/webapps/bed5.php'),(184,'website','homepage_footer_informasi_31','Display Antrian'),(185,'website','homepage_footer_informasi_32','http://localhost/webapps/antrian.php'),(186,'website','homepage_sosmed_facebook','basoro'),(187,'website','homepage_sosmed_youtube','basoro'),(188,'website','homepage_sosmed_instagram','basoro');
...
INSERT INTO `mlite_users` VALUES (1,'admin','Administrator','Admin ganteng baik hati, suka menabung dan tidak sombong.','$2y$10$pgRnDiukCbiYVqsamMM3ROWViSRqbyCCL33N8.ykBKZx0dlplXe9i','avatar6270cf63624c5.png','info@mlite.id','admin','','all');
...
-- Dump completed on 2022-05-03 14:50:16

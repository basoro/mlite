                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          <table id="datatable" class="table responsive table-bordered table-striped table-hover display nowrap js-exportable" width="100%">
                            ...
                            <tbody>
                              <?php
                              		$sql = "SELECT reg_periksa.no_rawat , pasien.nm_pasien , reg_periksa.no_rkm_medis , penjab.png_jawab FROM reg_periksa , pasien , penjab WHERE reg_periksa.no_rkm_medis = pasien.no_rkm_medis AND reg_periksa.kd_pj = penjab.kd_pj AND reg_periksa.kd_poli='IGDK' AND reg_periksa.tgl_registrasi='{$date}'";
									$list = query($sql);

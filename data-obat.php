            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA OBAT <?php if(isset($_POST['tanggal'])) { echo "Tanggal ".$_POST['tanggal']; } ?>
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <table id="datatable" class="table table-bordered table-striped table-hover display nowrap js-exportable" width="100%">
                                ...
                                $sql = "SELECT a.nama_brng, b.kode_brng, b.stok_akhir, MAX(b.tanggal) AS tgl_update FROM databarang a, riwayat_barang_medis b WHERE a.kode_brng = b.kode_brng AND a.status = '1'";
                                if($tanggal) {

...
<body style="background: #222 url('themes/admin/img/wallpaper.jpg'); background-repeat: no-repeat;  background-size: cover;">
    <section id="login" style="background: #222;padding:20px;">
        <div class="panel panel-default">
            <div class="panel-heading">
                <img src="themes/admin/img/logo.png"> <h2 style="color: #999;"><span>m</span>LITE Indonesia</h2>
                <div style="color: white;font-size: 20px;">Pemasangan awal</div>
            </div>
            <?php
            if($mysqli->query("SHOW TABLES LIKE 'mlite_settings'")->num_rows  == 1) {
                header("Location: ./");
            }
            ...
            if($action == 'finish') {
              ...
              if(isset($_POST['finish'])) {
                ...
                ?>
                  <div class="row">
                      <div class="col-xs-12">
                          <div id="notify" class="alert-success animated shake" style="margin-bottom:20px;">Instalasi SIMKES mLITE Indonesia selesai!<br>Silahkan hapus file install.php untuk mencegah digunakan menggangu sistem anda.</div>
                          <br>
                              <a href="./admin/" class="btn btn-success btn-lg btn-block">LOGIN</a>
                          <br>
                          <div style="color: white">
                            <label>Username:</labe> <b>admin</b><br>
                            <label>Password:</labe> <b>admin</b>
                          </div>
                      </div>
                  </div>
                <?php

...
<div class="card">
    <div class="header">
      <h2>Inhealth Pasien Rawat Jalan</h2>
    </div>
    <div class="body">
      <?php display_message(); ?>
      <br>
      ...
      <table id="datatable" class="table responsive table-bordered table-striped table-hover display nowrap js-exportable" width="100%">
        ...
        AND
        reg_periksa.tgl_registrasi BETWEEN '2019-10-01' AND '2020-01-01'
        AND
        ...
        reg_periksa.kd_pj = penjab.kd_pj";
          ...
          $sql .= " ORDER BY reg_periksa.kd_poli ASC";
          $result = query($sql);
          while ($row = fetch_array($result)) {
              $get_no_rawat = $row['6']; ?>
              <tr>
                <td><?php echo SUBSTR($row['0'], 0, 15).' ...'; ?></td>
                <td><input type="button" value="<?php echo $row['1']; ?>" class="btn btn-primary cek" id="norm" /></td>

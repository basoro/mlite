      ...
      if (strlen($r) > 1) {
        ...
        'Content-Type:application/json',
          ...
          foreach ($dpjp['response']['list'] as $kode):
            ...
            $int3 = $kode['kode'] == "289282" && $drdr['0'] == "D0000073"; // dr yusar
            ...
            $gnd1 = $kode['kode'] == "274754" && $drdr['0'] == "D0000055"; // dr juli
             switch (true) {
               ...
               case $int3:echo '<input type="hidden" value="289282" id="dpjp" name="dpjp"><input type="hidden" value="'.$drdr['1'].'" id="dpjp" name="nmdpjp">';break;
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <div class="form-line">
                                    ...
                                    <input type="number" class="form-control" name="notlp" required minlength=8 maxlength=13 value="<?php if ($b['no_tlp'] == "") {
        echo "000000000000";
    }{echo $b['no_tlp'];} ?>">
                                  </div>
                                </div>
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="skdp" value="<?php if ($sksk['no_antrian'] == "") {
                                  echo $nonbooking;
                              }{echo $sksk['no_antrian'];};?>" placeholder="No SKDP">
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-2" style="display:none;">

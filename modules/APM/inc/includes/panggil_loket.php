			      ...
			      <div class="card-header" style="font-size:32px;">Loket <?php echo $value; ?></div>
				    ...
				    <div class="card-footer p-0">
							<div class="btn-group btn-group-justified">
							  <a href="#" class="btn btn-primary" style="font-size:32px;"><?php $q = fetch_assoc(query("SELECT MAX(noantrian) as q FROM antrian_loket WHERE type = 'Loket' AND postdate LIKE current_date()")); if(empty($q['q'])) { echo '0'; } else { echo $q['q']; } ?></a>

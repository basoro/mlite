    ...
    <div class="content m-t-30">
      ...
      if(!$action){?>
        <table id="datatable" class="table responsive table-bordered table-striped table-hover display nowrap js-exportable" width="100%">
          ...
          <tbody>
            <?php
                $sql = "SELECT reg_periksa.no_rkm_medis , pasien.nm_pasien , pasien.tgl_lahir , reg_periksa.no_rawat , poliklinik.nm_poli , penjab.png_jawab FROM reg_periksa , pasien , poliklinik , penjab WHERE reg_periksa.no_rkm_medis = pasien.no_rkm_medis AND reg_periksa.kd_pj = penjab.kd_pj AND reg_periksa.kd_poli NOT IN('IGDK') AND reg_periksa.kd_poli = poliklinik.kd_poli AND tgl_registrasi = CURRENT_DATE()";
            ...
            <tr>
              ...
              <td><a class="btn btn-primary" href="./?module=BridgingBPJS&page=rawat_jalan&action=sep&no_rawat=<?php echo $a['no_rawat'];?>">Cek Bridging PCare</a></td>
        ...
        <form method="post" action="buildsep.php">
          ...
          <div class="form-group">
                <div class="form-line">
                  ...
                  <input type="text" class="form-control" name="ppk" value="<?php echo $kode_ppk; ?>" readonly>
                </div>
              </div>
            </div>
            <div class="col-md-3">
          ...
          <?php include('modules/BridgingBPJS/includes/bridging.php'); ?>
        <div class="row clearfix">
           <div class="col-md-2">
            <div class="form-group">

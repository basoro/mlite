...
switch ($version) {
   ...
   case '4.0.7':
    ...
    case '4.1.5':
        ...
        $this->core->db()->pdo()->exec("INSERT INTO `mlite_settings` (`module`, `field`, `value`) VALUES ('settings', 'username-fp', '')");
        $this->core->db()->pdo()->exec("INSERT INTO `mlite_settings` (`module`, `field`, `value`) VALUES ('settings', 'password-fp', '')");
        $return = '4.1.6';        
    }
return $return;

   ...
   case '4.0.7':
    ...
    case '5.2.0':
          $this->core->db()->pdo()->exec("CREATE TABLE  `catatan_adime_gizi`  (
            `no_rawat` varchar(17) NOT NULL,
            `tanggal` datetime NOT NULL,
            `asesmen` varchar(1000) NULL DEFAULT NULL,
            `diagnosis` varchar(1000) NULL DEFAULT NULL,
            `intervensi` varchar(1000) NULL DEFAULT NULL,
            `monitoring` varchar(1000) NULL DEFAULT NULL,
            `evaluasi` varchar(1000) NULL DEFAULT NULL,
            `instruksi` varchar(1000) NULL DEFAULT NULL,
            `nip` varchar(20) NULL DEFAULT NULL,
            PRIMARY KEY (`no_rawat`, `tanggal`) USING BTREE,
            INDEX `nip`(`nip` ASC) USING BTREE
          ) ENGINE = InnoDB DEFAULT CHARSET=latin1;");

          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_api_key`  (
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_apotek_online_log`  (
            `id` int NOT NULL AUTO_INCREMENT,
            `no_rawat` varchar(17) NOT NULL,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_apotek_online_maping_obat`  (
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_apotek_online_resep_response_log`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_apotek_online_sep_data`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_disabled_menu`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_eklaim_logs`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_idr_codes`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_inacbg_codes`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_loinc_radiologi`  (
            `No` text NULL,
            `Kategori` text NULL,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_news`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_news_tags`  (
            `id` int NOT NULL AUTO_INCREMENT,
            `name` varchar(225) NULL DEFAULT NULL,
            `slug` varchar(225) NULL DEFAULT NULL,
            PRIMARY KEY (`id`) USING BTREE
          ) ENGINE = InnoDB  DEFAULT CHARSET=latin1;");

          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_news_tags_relationship`  (
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_query_logs`  (
            `id` int NOT NULL AUTO_INCREMENT,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_rujukan_internal_poli`  (
            `no_rawat` varchar(17) NOT NULL,
            `kd_dokter` varchar(20) NOT NULL,
            `kd_poli` varchar(5) NULL DEFAULT NULL,
            `isi_rujukan` text NULL,
            `jawab_rujukan` text NULL,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_satu_sehat_mapping_lab`  (
            ...
            `kd_jenis_prw` varchar(15) NULL DEFAULT NULL,
            `code` varchar(15) NULL DEFAULT NULL,
            `system` varchar(100) NOT NULL,
            `display` varchar(80) NULL DEFAULT NULL,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_satu_sehat_mapping_obat`  (
            ...
            `id_medication` varchar(50) NULL DEFAULT NULL,
            PRIMARY KEY (`kode_brng`) USING BTREE
          ) ENGINE = InnoDB DEFAULT CHARSET=latin1;");
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `mlite_triase_igd`  (
            ...
            `tekanan_darah` varchar(10) NULL DEFAULT NULL,
            ...
            `skala_triase` enum('1','2','3','4','5') NULL DEFAULT NULL,
            `keluhan_utama` text NULL,
            `diagnosa_awal` text NULL,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `penilaian_awal_keperawatan_igd`  (
            ...
            `gravida` varchar(20) NULL DEFAULT NULL,
            `para` varchar(20) NULL DEFAULT NULL,
            `abortus` varchar(20) NULL DEFAULT NULL,
            `hpht` varchar(20) NULL DEFAULT NULL,
            ...
            `jumlah_perdarahan` char(5) NULL DEFAULT NULL,
            `warna_perdarahan` varchar(40) NULL DEFAULT '',
            `intoksikasi` enum('Tidak Ada','Ada','Gigitan Binatang','Zat Kimia','Gas','Obat') NOT NULL,
            `bab` char(2) NULL DEFAULT NULL,
            `xbab` varchar(10) NULL DEFAULT NULL,
            `kbab` varchar(40) NULL DEFAULT NULL,
            `wbab` varchar(40) NULL DEFAULT NULL,
            `bak` char(2) NULL DEFAULT NULL,
            `xbak` varchar(10) NULL DEFAULT NULL,
            `wbak` varchar(40) NULL DEFAULT '',
            `lbak` varchar(40) NULL DEFAULT '',
            ...
            `dilaporkan` varchar(50) NULL DEFAULT NULL,
            `sebutkan` varchar(50) NULL DEFAULT NULL,
            `hubungan` enum('Harmonis','Kurang Harmonis','Tidak Harmonis','Konflik Besar') NOT NULL,
            `tinggal_dengan` enum('Sendiri','Orang Tua','Suami / Istri','Lainnya') NOT NULL,
            `ket_tinggal` varchar(50) NULL DEFAULT '',
            `budaya` enum('Tidak Ada','Ada') NOT NULL,
            `ket_budaya` varchar(50) NOT NULL,
            `pendidikan_pj` enum('-','TS','TK','SD','SMP','SMA','SLTA/SEDERAJAT','D1','D2','D3','D4','S1','S2','S3') NOT NULL,
            `ket_pendidikan_pj` varchar(50) NULL DEFAULT NULL,
            `edukasi` enum('Pasien','Keluarga') NOT NULL,
            `ket_edukasi` varchar(50) NOT NULL,
            ...
            `alat_bantu` enum('Tidak','Ya') NOT NULL,
            `ket_bantu` varchar(50) NULL DEFAULT '',
            `nyeri` enum('Tidak Ada Nyeri','Nyeri Akut','Nyeri Kronis') NOT NULL,
            `provokes` enum('Proses Penyakit','Benturan','Lain-lain') NOT NULL,
            `ket_provokes` varchar(40) NOT NULL,
            `quality` enum('Seperti Tertusuk','Berdenyut','Teriris','Tertindih','Tertiban','Lain-lain') NOT NULL,
            ...
            `durasi` varchar(25) NOT NULL,
            `nyeri_hilang` enum('Istirahat','Medengar Musik','Minum Obat') NOT NULL,
            `ket_nyeri` varchar(40) NULL DEFAULT NULL,
            `pada_dokter` enum('Tidak','Ya') NOT NULL,
            `ket_dokter` varchar(15) NULL DEFAULT NULL,
            `berjalan_a` enum('Ya','Tidak') NOT NULL,
            `berjalan_b` enum('Ya','Tidak') NOT NULL,
            `berjalan_c` enum('Ya','Tidak') NOT NULL,
            `hasil` enum('Tidak beresiko (tidak ditemukan a dan b)','Resiko rendah (ditemukan a/b)','Resiko tinggi (ditemukan a dan b)') NOT NULL,
            `lapor` enum('Ya','Tidak') NOT NULL,
            `ket_lapor` varchar(15) NULL DEFAULT NULL,
          ...
          $this->core->db()->pdo()->exec("CREATE TABLE  `penilaian_awal_keperawatan_ranap`  (
            ...
            `ket_informasi` varchar(30) NOT NULL,
            `tiba_diruang_rawat` enum('Jalan Tanpa Bantuan','Kursi Roda','Brankar') NOT NULL,
            `kasus_trauma` enum('Trauma','Non Trauma') NULL DEFAULT NULL,
            `cara_masuk` enum('Poli','IGD','Lain-lain') NOT NULL,
            `rps` varchar(300) NOT NULL,
            `rpd` varchar(100) NOT NULL,
            `rpk` varchar(100) NOT NULL,
            ...
            `penilaian_nyeri_diberitahukan_dokter` enum('Tidak','Ya') NOT NULL,
            `penilaian_nyeri_jam_diberitahukan_dokter` varchar(10) NOT NULL,
            `penilaian_jatuhmorse_skala1` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhmorse_nilai1` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhmorse_skala2` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhmorse_nilai2` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhmorse_skala3` enum('Tidak Ada/Kursi Roda/Perawat/Tirah Baring','Tongkat/Alat Penopang','Berpegangan Pada Perabot') NULL DEFAULT NULL,
            `penilaian_jatuhmorse_nilai3` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhmorse_skala4` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhmorse_nilai4` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhmorse_skala5` enum('Normal/Tirah Baring/Imobilisasi','Lemah','Terganggu') NULL DEFAULT NULL,
            `penilaian_jatuhmorse_nilai5` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhmorse_skala6` enum('Sadar Akan Kemampuan Diri Sendiri','Sering Lupa Akan Keterbatasan Yang Dimiliki') NULL DEFAULT NULL,
            `penilaian_jatuhmorse_nilai6` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhmorse_totalnilai` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala1` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai1` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala2` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai2` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala3` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai3` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala4` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai4` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala5` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai5` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala6` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai6` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala7` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai7` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala8` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai8` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala9` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai9` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala10` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai10` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_skala11` enum('Tidak','Ya') NULL DEFAULT NULL,
            `penilaian_jatuhsydney_nilai11` tinyint NULL DEFAULT NULL,
            `penilaian_jatuhsydney_totalnilai` tinyint NULL DEFAULT NULL,
            `skrining_gizi1` enum('Tidak ada penurunan berat badan','Tidak yakin/ tidak tahu/ terasa baju lebih longgar','Ya 1-5 kg','Ya 6-10 kg','Ya 11-15 kg','Ya > 15 kg') NULL DEFAULT NULL,
            `nilai_gizi1` int NULL DEFAULT NULL,
            `skrining_gizi2` enum('Tidak','Ya') NULL DEFAULT NULL,
            `nilai_gizi2` int NULL DEFAULT NULL,
            `nilai_total_gizi` double NULL DEFAULT NULL,
            `skrining_gizi_diagnosa_khusus` enum('Tidak','Ya') NULL DEFAULT NULL,
            `skrining_gizi_ket_diagnosa_khusus` varchar(50) NULL DEFAULT NULL,
            `skrining_gizi_diketahui_dietisen` enum('Tidak','Ya') NULL DEFAULT NULL,
            `skrining_gizi_jam_diketahui_dietisen` varchar(10) NULL DEFAULT NULL,
            `rencana` varchar(200) NULL DEFAULT NULL,
            `nip1` varchar(20) NOT NULL,
            `nip2` varchar(20) NOT NULL,
            `kd_dokter` varchar(20) NOT NULL,
            PRIMARY KEY (`no_rawat`) USING BTREE,
          ...
          $this->core->db()->pdo()->exec("ALTER TABLE `catatan_adime_gizi` ADD CONSTRAINT `catatan_adime_gizi_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `catatan_adime_gizi` ADD CONSTRAINT `catatan_adime_gizi_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `petugas` (`nip`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_news_tags_relationship` ADD CONSTRAINT `mlite_news_tags_relationship_ibfk_1` FOREIGN KEY (`news_id`) REFERENCES `mlite_news` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_news_tags_relationship` ADD CONSTRAINT `mlite_news_tags_relationship_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `mlite_news_tags` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_rujukan_internal_poli` ADD CONSTRAINT `mlite_rujukan_internal_poli_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_rujukan_internal_poli` ADD CONSTRAINT `mlite_rujukan_internal_poli_ibfk_2` FOREIGN KEY (`kd_dokter`) REFERENCES `dokter` (`kd_dokter`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_rujukan_internal_poli` ADD CONSTRAINT `mlite_rujukan_internal_poli_ibfk_3` FOREIGN KEY (`kd_poli`) REFERENCES `poliklinik` (`kd_poli`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_satu_sehat_mapping_lab` ADD CONSTRAINT `mlite_satu_sehat_mapping_lab_ibfk_1` FOREIGN KEY (`id_template`) REFERENCES `template_laboratorium` (`id_template`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_satu_sehat_mapping_obat` ADD CONSTRAINT `mlite_satu_sehat_mapping_obat_ibfk_1` FOREIGN KEY (`kode_brng`) REFERENCES `databarang` (`kode_brng`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_satu_sehat_mapping_rad` ADD CONSTRAINT `mlite_satu_sehat_mapping_rad_ibfk_1` FOREIGN KEY (`kd_jenis_prw`) REFERENCES `jns_perawatan_radiologi` (`kd_jenis_prw`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mlite_triase_igd` ADD CONSTRAINT `fk_triase_reg_periksa` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mutasibarang` ADD CONSTRAINT `mutasibarang_ibfk_1` FOREIGN KEY (`kode_brng`) REFERENCES `databarang` (`kode_brng`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mutasibarang` ADD CONSTRAINT `mutasibarang_ibfk_2` FOREIGN KEY (`kd_bangsaldari`) REFERENCES `bangsal` (`kd_bangsal`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `mutasibarang` ADD CONSTRAINT `mutasibarang_ibfk_3` FOREIGN KEY (`kd_bangsalke`) REFERENCES `bangsal` (`kd_bangsal`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_igd` ADD CONSTRAINT `penilaian_awal_keperawatan_igd_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_igd` ADD CONSTRAINT `penilaian_awal_keperawatan_igd_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `petugas` (`nip`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_ralan` ADD CONSTRAINT `penilaian_awal_keperawatan_ralan_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_ralan` ADD CONSTRAINT `penilaian_awal_keperawatan_ralan_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `petugas` (`nip`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_ranap` ADD CONSTRAINT `penilaian_awal_keperawatan_ranap_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_ranap` ADD CONSTRAINT `penilaian_awal_keperawatan_ranap_ibfk_2` FOREIGN KEY (`nip1`) REFERENCES `petugas` (`nip`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_ranap` ADD CONSTRAINT `penilaian_awal_keperawatan_ranap_ibfk_3` FOREIGN KEY (`nip2`) REFERENCES `petugas` (`nip`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_awal_keperawatan_ranap` ADD CONSTRAINT `penilaian_awal_keperawatan_ranap_ibfk_4` FOREIGN KEY (`kd_dokter`) REFERENCES `dokter` (`kd_dokter`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_medis_igd` ADD CONSTRAINT `penilaian_medis_igd_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_medis_igd` ADD CONSTRAINT `penilaian_medis_igd_ibfk_2` FOREIGN KEY (`kd_dokter`) REFERENCES `dokter` (`kd_dokter`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_medis_ralan` ADD CONSTRAINT `penilaian_medis_ralan_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_medis_ralan` ADD CONSTRAINT `penilaian_medis_ralan_ibfk_2` FOREIGN KEY (`kd_dokter`) REFERENCES `dokter` (`kd_dokter`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_medis_ranap` ADD CONSTRAINT `penilaian_medis_ranap_ibfk_1` FOREIGN KEY (`no_rawat`) REFERENCES `reg_periksa` (`no_rawat`) ON DELETE CASCADE ON UPDATE CASCADE;");

          $this->core->db()->pdo()->exec("ALTER TABLE `penilaian_medis_ranap` ADD CONSTRAINT `penilaian_medis_ranap_ibfk_2` FOREIGN KEY (`kd_dokter`) REFERENCES `dokter` (`kd_dokter`) ON DELETE CASCADE ON UPDATE CASCADE;");

...
import { User, Calendar, Clock, Stethoscope, FileText, AlertCircle, ChevronLeft, Activity, Pill, Thermometer, Plus, X, FlaskConical, Scan, Book } from 'lucide-react-native';
           ...
           <View style={styles.infoCard}>
             <View style={styles.infoRow}>
               <View style={styles.infoIcon}>
                 <Stethoscope color="#4A90E2" size={20} />
               </View>

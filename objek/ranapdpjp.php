...
curl_setopt($ch, CURLOPT_URL, BpjsApiUrl."referensi/dokter/pelayanan/1/tglPelayanan/".$date."/Spesialis/".$q);
...
//while($row = fetch_assoc($sql)){
	foreach($dr['response']['list'] as $key => $value):

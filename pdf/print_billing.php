...
if(isset($_GET['no_rawat'])) {
    ...
    $found_pasien = $mysqli->query($_sql);
    if($found_pasien->num_rows == 1) {
	     while($row = $found_pasien->fetch_array()) {
	        $no_rkm_medis  = $row['0'];
	        $get_no_rawat	 = $row['1'];
          $no_rawat	     = $row['1'];
	        $nm_pasien     = $row['2'];
  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-money"></i> Billing <?php echo setting('nama_instansi'); ?>
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        Dari
        <address>
          <strong><?php echo setting('nama_instansi'); ?></strong><br>
          <?php echo setting('alamat_instansi'); ?><br>
          Phone: <?php echo setting('kontak'); ?><br>
    ...
    <div class="row">
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped">
          ...
          <?php
          $query_tindakan = $mysqli->query("SELECT a.kd_jenis_prw, a.tgl_perawatan, a.tarif_tindakandr, b.nm_perawatan  FROM rawat_jl_dr a, jns_perawatan b WHERE a.kd_jenis_prw = b.kd_jenis_prw AND a.no_rawat = '{$no_rawat}'");
          $total_tindakan = 0;
          ...
          <tr>
           ...
           <?php
           $query_resep = $mysqli->query("SELECT a.kode_brng, a.jml, a.aturan_pakai, b.nama_brng, a.no_resep, b.jualbebas FROM resep_dokter a, databarang b, resep_obat c WHERE a.kode_brng = b.kode_brng AND a.no_resep = c.no_resep AND c.no_rawat = '{$no_rawat}'");
           $total_obat = 0;
           ...
           <tr>
            ...
            <?php
            $query_tambahan_biaya = $mysqli->query("SELECT * FROM tambahan_biaya WHERE no_rawat = '{$no_rawat}'");
            $total_tambahan = 0;

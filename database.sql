...
--
-- Host: localhost
-- Generation Time: Oct 02, 2024 at 02:04 AM
...
--
-- Table structure for table `mlite_disabled_menu`
--
...
CREATE TABLE `mlite_disabled_menu` (
  ...
  `create` varchar(10) NOT NULL DEFAULT 'false',
  `read` varchar(10) NOT NULL DEFAULT 'false',
  `update` varchar(10) NOT NULL DEFAULT 'false',
...
--
-- Table structure for table `mlite_log_api_vclaim`
--

CREATE TABLE `mlite_log_api_vclaim` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `mlite_log_query_database`
--

CREATE TABLE `mlite_log_query_database` (
  `id` int(11) NOT NULL,
  `user` varchar(20) NOT NULL,
  `tanggal` date NOT NULL,
  `endpoint` varchar(250) NOT NULL,
...
(6, 'dokter', '5'),
(7, 'jnj_jabatan', '6'),
(143, 'bahasa_pasien', '140'),
(9, 'cacat_fisik', '8'),
(10, 'crud_generator', '9'),
(11, 'databarang', '10'),
(12, 'jns_perawatan', '11'),
(13, 'jns_perawatan_inap', '12'),
(14, 'jns_perawatan_lab', '13'),
(15, 'jns_perawatan_radiologi', '14'),
(16, 'kamar', '15'),
(17, 'kategori_perawatan', '16'),
(18, 'kelompok_jabatan', '17'),
(19, 'kodesatuan', '18'),
(20, 'master_aturan_pakai', '19'),
(21, 'master_berkas_digital', '20'),
(22, 'metode_racik', '21'),
(23, 'mlite_api_tools', '22'),
(24, 'pasien', '23'),
(25, 'pegawai', '24'),
(26, 'pemeriksaan_ralan', '25'),
(27, 'pendidikan', '26'),
(28, 'penjab', '27'),
(29, 'perusahaan_pasien', '28'),
(30, 'petugas', '29'),
(31, 'poliklinik', '30'),
(32, 'rawat_jl_dr', '31'),
(33, 'rawat_jl_drpr', '32'),
...
(35, 'reg_periksa', '34'),
(36, 'resep_dokter', '35'),
(37, 'resep_dokter_racikan', '36'),
(38, 'resep_dokter_racikan_detail', '37'),
(39, 'resep_obat', '38'),
(40, 'resiko_kerja', '39'),
(41, 'ruang_ok', '40'),
(153, 'stts_wp', '141'),
(152, 'stts_kerja', '140'),
(151, 'spesialis', '139'),
(46, 'permintaan_detail_permintaan_lab', '45'),
(47, 'permintaan_lab', '46'),
(48, 'permintaan_pemeriksaan_lab', '47'),
(49, 'template_laboratorium', '48'),
(50, 'permintaan_pemeriksaan_radiologi', '49'),
(52, 'permintaan_radiologi', '50'),
(53, 'bank', '51'),
(54, 'bidang', '52'),
(55, 'departemen', '53'),
(56, 'emergency_index', '54'),
(57, 'golongan_barang', '55'),
(58, 'industrifarmasi', '56'),
(59, 'jabatan', '57'),
(60, 'jenis', '58'),
(61, 'kategori_barang', '59'),
(62, 'kategori_penyakit', '60'),
(63, 'kamar_inap', '61'),
(64, 'aturan_pakai', '62'),
(65, 'barcode', '63'),
(66, 'beri_obat_operasi', '64'),
(67, 'berkas_digital_perawatan', '65'),
(68, 'booking_operasi', '66'),
(69, 'booking_periksa', '67'),
(70, 'booking_periksa_balasan', '68'),
(71, 'booking_periksa_diterima', '69'),
(72, 'booking_registrasi', '70'),
(73, 'bpjs_prb', '71'),
(74, 'bridging_rujukan_bpjs', '72'),
(75, 'bridging_sep', '73'),
(76, 'bridging_sep_internal', '74'),
(77, 'bridging_srb_bpjs', '75'),
(78, 'bridging_surat_kontrol_bpjs', '76'),
(79, 'bridging_surat_pri_bpjs', '77'),
(80, 'catatan_perawatan', '78'),
(81, 'detail_pemberian_obat', '79'),
(82, 'detail_periksa_lab', '80'),
(83, 'diagnosa_pasien', '81'),
(84, 'dpjp_ranap', '82'),
(85, 'gambar_radiologi', '83'),
(86, 'gudangbarang', '84'),
(87, 'hasil_radiologi', '85'),
(88, 'icd9', '86'),
(89, 'inventaris', '87'),
(90, 'inventaris_barang', '88'),
(91, 'inventaris_jenis', '89'),
(92, 'inventaris_kategori', '90'),
(93, 'inventaris_merk', '91'),
(94, 'inventaris_peminjaman', '92'),
(95, 'inventaris_produsen', '93'),
(96, 'inventaris_ruang', '94'),
(97, 'jadwal', '95'),
(98, 'jadwal_pegawai', '96'),
(99, 'jadwal_tambahan', '97'),
(100, 'jam_jaga', '98'),
(101, 'jam_masuk', '99'),
(102, 'kabupaten', '100'),
(103, 'kecamatan', '101'),
(104, 'kelurahan', '102'),
(105, 'laporan_operasi', '103'),
(106, 'maping_dokter_dpjpvclaim', '104'),
(107, 'maping_poli_bpjs', '105'),
(108, 'maping_poliklinik_pcare', '106'),
(109, 'prosedur_pasien', '107'),
(110, 'rawat_inap_dr', '108'),
(111, 'rawat_inap_drpr', '109'),
(112, 'rawat_inap_pr', '110'),
(113, 'rekap_presensi', '111'),
(114, 'resep_pulang', '112'),
(115, 'resume_pasien', '113'),
(116, 'resume_pasien_ranap', '114'),
(117, 'riwayat_barang_medis', '115'),
(118, 'set_keterlambatan', '116'),
(119, 'set_no_rkm_medis', '117'),
(120, 'skdp_bpjs', '118'),
(121, 'tambahan_biaya', '119'),
(122, 'temporary_presensi', '120'),
(148, 'utd_pendonor', '141'),
(146, 'utd_donor', '139'),
(147, 'utd_komponen_darah', '140'),
(127, 'mutasi_berkas', '125'),
(128, 'obat_racikan', '126'),
(129, 'obatbhp_ok', '127'),
(130, 'operasi', '128'),
(131, 'opname', '129'),
(132, 'paket_operasi', '130'),
(133, 'pemeliharaan_inventaris', '131'),
(134, 'pemeriksaan_ranap', '132'),
(135, 'penilaian_medis_ralan', '133'),
(136, 'penyakit', '134'),
(137, 'perbaikan_inventaris', '135'),
(138, 'periksa_lab', '136'),
(139, 'periksa_radiologi', '137'),
(140, 'permintaan_perbaikan_inventaris', '138'),
(141, 'personal_pasien', '139'),
(142, 'propinsi', '140'),
(156, 'bridging_vclaim_bpjs', '143'),
(145, 'mlite_antrian_referensi', '142'),
(149, 'utd_stok_darah', '142'),
(154, 'suku_bangsa', '142'),
(155, 'mlite_log_api_vclaim', '143'),
(158, 'mlite_billing', '145'),
(159, 'mlite_log_query_database', '146'),
(162, 'mutasibarang', '147');
...
(26, 'settings', 'timezone', 'Asia/Makassar'),
(25, 'settings', 'BpjsServiceName', 'vclaim-rest'),
(24, 'settings', 'BpjsUserKey', '1540f18269a9fd40a5ac2845b6e5a8d1'),
(23, 'settings', 'BpjsSecretKey', 'WEYUI254ilo'),
(22, 'settings', 'BpjsConsID', '29459'),
(21, 'settings', 'BpjsApiUrl', 'https://apijkn.bpjs-kesehatan.go.id'),
(20, 'settings', 'notif_presensi', 'true'),
(19, 'settings', 'responsivevoice', 'false'),
(18, 'settings', 'ceklimit', 'false'),
(16, 'settings', 'dokter_ralan_per_dokter', 'false'),
(17, 'settings', 'cekstatusbayar', 'false'),
(15, 'settings', 'pj_radiologi', 'DR001'),
(13, 'settings', 'pj_laboratorium', 'DR001'),
(14, 'settings', 'radiologi', '-'),
(11, 'settings', 'igd', 'IGDK'),
(12, 'settings', 'laboratorium', '-'),
(10, 'settings', 'footer', 'Copyright {?=date(\"Y\")?} &copy; by drg. F. Basoro. All rights reserved.'),
(9, 'settings', 'ppk_bpjs', '1708R008'),
...
(3, 'settings', 'alamat', 'Jl. Murakata 04'),
(2, 'settings', 'nama_instansi', 'RSUD H. Damanhuri'),
(1, 'settings', 'logo', 'uploads/settings/logo.png'),
(27, 'settings', 'input_kasir', 'tidak'),
(28, 'settings', 'editor', 'wysiwyg'),
(29, 'settings', 'version', '4.0.7'),
(30, 'settings', 'update_check', '0'),
(31, 'settings', 'update_changelog', ''),
(32, 'settings', 'update_version', '0'),
(33, 'settings', 'license', ''),
(34, 'settings', 'logquery', '1');
...
(1, 'admin', 'Administrator', 'Admin ganteng baik hati, suka menabung dan tidak sombong.', '$2y$10$pgRnDiukCbiYVqsamMM3ROWViSRqbyCCL33N8.ykBKZx0dlplXe9i', 'avatar66ba1e703a355.png', 'info@mlite.id', 'admin', '-', 'all');
...
ALTER TABLE `mlite_api_key`
  ADD PRIMARY KEY (`id`),
  ADD KEY `mlite_api_key_ibfk_1` (`username`);
...
--
-- Indexes for table `mlite_disabled_menu`
--
ALTER TABLE `mlite_disabled_menu`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user` (`user`,`module`);
...
--
-- Indexes for table `mlite_log_api_vclaim`
--
ALTER TABLE `mlite_log_api_vclaim`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mlite_log_query_database`
--
ALTER TABLE `mlite_log_query_database`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `mutasibarang`
  ADD PRIMARY KEY (`kode_brng`,`kd_bangsaldari`,`kd_bangsalke`,`tanggal`,`no_batch`,`no_faktur`),
  ADD KEY `kd_bangsaldari` (`kd_bangsaldari`),
  ADD KEY `kd_bangsalke` (`kd_bangsalke`),
  ADD KEY `jml` (`jml`),
  ADD KEY `keterangan` (`keterangan`),
  ADD KEY `kode_brng` (`kode_brng`);
...
--
-- AUTO_INCREMENT for table `mlite_disabled_menu`
--
ALTER TABLE `mlite_disabled_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `mlite_log_api_vclaim`
--
ALTER TABLE `mlite_log_api_vclaim`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mlite_log_query_database`
--
ALTER TABLE `mlite_log_query_database`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

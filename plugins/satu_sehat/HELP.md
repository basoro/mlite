...
Dokumentasi penggunaan plugin **Satu Sehat** pada mLITE.

## Deskripsi Singkat

Modul Satu Sehat Kemkes

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Satu Sehat** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Satu Sehat**.
2. Masuk ke menu **Satu Sehat** untuk menjalankan proses sesuai alur kerja unit.

...
return [
    ...
    'install'       =>  function () use ($core) {
        ...
        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `temporary_presensi` (
          `id` int(11) NOT NULL,
        ...
        $core->mysql()->pdo()->exec("ALTER TABLE `temporary_presensi`
          ADD PRIMARY KEY (`id`);");

        $core->mysql()->pdo()->exec("ALTER TABLE `temporary_presensi`
          ADD CONSTRAINT `temporary_presensi_ibfk_1` FOREIGN KEY (`id`) REFERENCES `pegawai` (`id`) ON UPDATE CASCADE;");

        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `rekap_presensi` (
          `id` int(10) NOT NULL,
          `shift` enum('Pagi','Pagi2','Pagi3','Pagi4','Pagi5','Pagi6','Pagi7','Pagi8','Pagi9','Pagi10','Siang','Siang2','Siang3','Siang4','Siang5','Siang6','Siang7','Siang8','Siang9','Siang10','Malam','Malam2','Malam3','Malam4','Malam5','Malam6','Malam7','Malam8','Malam9','Malam10','Midle Pagi1','Midle Pagi2','Midle Pagi3','Midle Pagi4','Midle Pagi5','Midle Pagi6','Midle Pagi7','Midle Pagi8','Midle Pagi9','Midle Pagi10','Midle Siang1','Midle Siang2','Midle Siang3','Midle Siang4','Midle Siang5','Midle Siang6','Midle Siang7','Midle Siang8','Midle Siang9','Midle Siang10','Midle Malam1','Midle Malam2','Midle Malam3','Midle Malam4','Midle Malam5','Midle Malam6','Midle Malam7','Midle Malam8','Midle Malam9','Midle Malam10') NOT NULL,
        ...
        $core->mysql()->pdo()->exec("ALTER TABLE `rekap_presensi`
        ...
        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `barcode` (
          `id` int(11) NOT NULL,
          `barcode` varchar(25) NOT NULL
        ) ENGINE=InnoDB DEFAULT CHARSET=latin1;");

        $core->mysql()->pdo()->exec("ALTER TABLE `barcode`
          ADD PRIMARY KEY (`id`),
        ...
        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `jam_jaga` (
        ...
        $core->mysql()->pdo()->exec("ALTER TABLE `jam_jaga`
        ...
        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `jadwal_pegawai` (
          `id` int(11) NOT NULL,
        ...
        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `set_keterlambatan` (
          `toleransi` int(11) DEFAULT NULL,
          `terlambat1` int(11) DEFAULT NULL,
          `terlambat2` int(11) DEFAULT NULL
        ) ENGINE=MyISAM DEFAULT CHARSET=latin1;");

        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `jam_masuk` (
          `shift` enum('Pagi','Pagi2','Pagi3','Pagi4','Pagi5','Pagi6','Pagi7','Pagi8','Pagi9','Pagi10','Siang','Siang2','Siang3','Siang4','Siang5','Siang6','Siang7','Siang8','Siang9','Siang10','Malam','Malam2','Malam3','Malam4','Malam5','Malam6','Malam7','Malam8','Malam9','Malam10','Midle Pagi1','Midle Pagi2','Midle Pagi3','Midle Pagi4','Midle Pagi5','Midle Pagi6','Midle Pagi7','Midle Pagi8','Midle Pagi9','Midle Pagi10','Midle Siang1','Midle Siang2','Midle Siang3','Midle Siang4','Midle Siang5','Midle Siang6','Midle Siang7','Midle Siang8','Midle Siang9','Midle Siang10','Midle Malam1','Midle Malam2','Midle Malam3','Midle Malam4','Midle Malam5','Midle Malam6','Midle Malam7','Midle Malam8','Midle Malam9','Midle Malam10') NOT NULL,
          `jam_masuk` time NOT NULL,
          `jam_pulang` time NOT NULL
        ) ENGINE=InnoDB DEFAULT CHARSET=latin1;");

        $core->mysql()->pdo()->exec("ALTER TABLE `jam_masuk`
          ADD PRIMARY KEY (`shift`);");

        $core->mysql()->pdo()->exec("INSERT INTO `jam_masuk` (`shift`, `jam_masuk`, `jam_pulang`) VALUES
        ...
        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `mlite_geolocation_presensi` (
            `id` int(11) NOT NULL,
        ...
        $core->mysql()->pdo()->exec('ALTER TABLE `mlite_geolocation_presensi`

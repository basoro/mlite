...
Dokumentasi penggunaan plugin **Pengguna** pada mLITE.
...
2. Buka menu **Pengguna** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Pengguna**.
2. Masuk ke menu **Pengguna** untuk menjalankan proses sesuai alur kerja unit.

    ...
    var var_tbl_permintaan_lab = $('#tbl_permintaan_lab').DataTable({
        ...
        "ajax": {
            ...
            "data": function (data) {
                ...
                data.search_field_permintaan_lab = search_field_permintaan_lab;
                data.search_text_permintaan_lab = search_text_permintaan_lab;
                
            }
        },
        "fnDrawCallback": function () {
            $('#more_data_permintaan_lab').on('click', function(e) {
                e.preventDefault();
                var clientX = e.originalEvent.clientX;
                var clientY = e.originalEvent.clientY;
                $('#tbl_permintaan_lab tr').contextMenu({x: clientX, y: clientY});
            });          
        }, 
        "columns": [
{ 'data': 'noorder' },
...
eTable += '<td>' + res[i]['diagnosa_klinis'] + '</td>';
    ...
    $("#view_chart").click(function () {
        window.open(mlite.url + '/permintaan_lab/chart?t=' + mlite.token, '_blank',"toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no,modal=yes");  
    })   

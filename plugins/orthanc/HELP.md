...
Dokumentasi penggunaan plugin **Orthanc** pada mLITE.

## Deskripsi Singkat

Bridging PACS via Orthanc

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Orthanc** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Orthanc**.
2. Masuk ke menu **Orthanc** untuk menjalankan proses sesuai alur kerja unit.

...
Dokumentasi penggunaan plugin **Penjualan** pada mLITE.

## Deskripsi Singkat

Modul penjualan bebas

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Penjualan** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Penjualan**.
2. Masuk ke menu **Penjualan** untuk menjalankan proses sesuai alur kerja unit.

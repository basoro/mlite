...
Dokumentasi penggunaan plugin **JKN Mobile FKTP** pada mLITE.

## Deskripsi Singkat

Modul JKN Mobile API untuk FKTP

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **JKN Mobile FKTP** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **JKN Mobile FKTP**.
2. Masuk ke menu **JKN Mobile FKTP** untuk menjalankan proses sesuai alur kerja unit.

...
Dokumentasi penggunaan plugin **Anjungan** pada mLITE.

## Deskripsi Singkat

Modul anjungan pasien rawat jalan

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Anjungan** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Anjungan**.
2. Masuk ke menu **Anjungan** untuk menjalankan proses sesuai alur kerja unit.

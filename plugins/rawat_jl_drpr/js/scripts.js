jQuery().ready(function () {
    var var_tbl_rawat_jl_drpr = $('#tbl_rawat_jl_drpr').DataTable({
        'processing': true,
        'serverSide': true,
        'serverMethod': 'post',
        'dom': 'Bfrtip',
        ...
        "ajax": {
            ...
            "data": function (data) {
                ...
                data.search_field_rawat_jl_drpr = search_field_rawat_jl_drpr;
                data.search_text_rawat_jl_drpr = search_text_rawat_jl_drpr;
                
            }
        },
        "fnDrawCallback": function () {
            $('#more_data_rawat_jl_drpr').on('click', function(e) {
                e.preventDefault();
                var clientX = e.originalEvent.clientX;
                var clientY = e.originalEvent.clientY;
                $('#tbl_rawat_jl_drpr tr').contextMenu({x: clientX, y: clientY});
            });          
        },        
        "columns": [
{ 'data': 'no_rawat' },
...
$('#stts_bayar').val(stts_bayar);
            ...
            $('#modal-title').text("Edit Data Rawat Jl Drpr");
...
$('#stts_bayar').val('');
        ...
        $('#modal-title').text("Tambah Data Rawat Jl Drpr");
        $("#modal_rawat_jl_drpr").modal('show');
    });
...
eTable += '<td>' + res[i]['stts_bayar'] + '</td>';
    ...
    $("#view_chart").click(function () {
        window.open(mlite.url + '/rawat_jl_drpr/chart?t=' + mlite.token, '_blank',"toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no,modal=yes");  
    })   

...
Dokumentasi penggunaan plugin **Laporan** pada mLITE.

## Deskripsi Singkat

Plugin untuk mengelola berbagai laporan rekam medis

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Laporan** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Laporan**.
2. Masuk ke menu **Laporan** untuk menjalankan proses sesuai alur kerja unit.

...
return [
    ...
    'install'       =>  function () use ($core) {
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'x_username', 'jkn')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'x_password', 'mobile')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'header_token', 'X-Token')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'header_username', 'X-Username')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'header_password', 'X-Password')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'BpjsConsID', '')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'BpjsSecretKey', '')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'BpjsUserKey', '')");
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'BpjsAntrianUrl', 'https://apijkn-dev.bpjs-kesehatan.go.id/antreanrs_dev/')");
      ...
      $core->db()->pdo()->exec("INSERT INTO `mlite__settings` (`module`, `field`, `value`) VALUES ('jkn_mobile', 'cacat_fisik', '')");

      $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `mlite__antrian_referensi` (
      ...
      $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `mlite__antrian_referensi_batal` (
      ...
      $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `mlite__antrian_referensi_taskid` (
        `tanggal_periksa` date NOT NULL,
        `nomor_referensi` varchar(50) NOT NULL,
    ...
    'uninstall'     =>  function () use ($core) {
      $core->db()->pdo()->exec("DELETE FROM `mlite__settings` WHERE `module` = 'jkn_mobile'");
    }
];

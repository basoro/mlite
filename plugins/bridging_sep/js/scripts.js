jQuery().ready(function () {
    var var_tbl_bridging_sep = $('#tbl_bridging_sep').DataTable({
        ...
        "fnDrawCallback": function () {
            $('#more_data_bridging_sep').on('click', function(e) {
                e.preventDefault();
                var clientX = e.originalEvent.clientX;
                var clientY = e.originalEvent.clientY;
                $('#tbl_bridging_sep tr').contextMenu({x: clientX, y: clientY});
            });          
        }, 
        "columns": [
{ 'data': 'no_sep' },
...
formData.append('typeact', typeact); // tambahan
    ...
    // ==============================================================
    $('#filter_search_bridging_sep').click(function () {
        var_tbl_bridging_sep.draw();
    });
...
$('#nmdpjplayanan').val(nmdpjplayanan);
            ...
            $('#modal-title').text("Edit Data Bridging Sep");
            $("#modal_bridging_sep").modal('show');
        }
        else {
...
$('#nmdpjplayanan').val('');
        ...
        $('#modal-title').text("Tambah Data Bridging Sep");
        $("#modal_bridging_sep").modal('show');
    });
...
eTable += '<td>' + res[i]['nmdpjplayanan'] + '</td>';
        ...
        $("#modal_lihat_bridging_sep").modal('show');
    });
    ...
    $("#view_chart").click(function () {
        window.open(mlite.url + '/bridging_sep/chart?t=' + mlite.token, '_blank',"toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no,modal=yes");  
    })   

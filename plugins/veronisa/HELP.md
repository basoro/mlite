...
Dokumentasi penggunaan plugin **Veronisa** pada mLITE.

## Deskripsi Singkat

Modul Verifikasi Obat Kronis

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Veronisa** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Veronisa**.
2. Masuk ke menu **Veronisa** untuk menjalankan proses sesuai alur kerja unit.

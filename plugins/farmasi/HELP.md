...
Dokumentasi penggunaan plugin **Farmasi** pada mLITE.

## Deskripsi Singkat

Pengelolaan data gudang farmasi.

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Farmasi** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Farmasi**.
2. Masuk ke menu **Farmasi** untuk menjalankan proses sesuai alur kerja unit.

...
Dokumentasi penggunaan plugin **Modul-Modul** pada mLITE.
...
2. Buka menu **Modul-Modul** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Modul-Modul**.
2. Masuk ke menu **Modul-Modul** untuk menjalankan proses sesuai alur kerja unit.

...
$stts_bayar = $_POST['stts_bayar'];
  ...
  'no_rawat'=>$no_rawat, 'kd_jenis_prw'=>$kd_jenis_prw[$l], 'nip'=>$nip, 'tgl_perawatan'=>$tgl_perawatan, 'jam_rawat'=>$jam_rawat, 'material'=>$material[$l], 'bhp'=>$bhp[$l], 'tarif_tindakanpr'=>$tarif_tindakanpr[$l], 'kso'=>$kso[$l], 'menejemen'=>$menejemen[$l], 'biaya_rawat'=>$biaya_rawat[$l], 'stts_bayar'=>$stts_bayar
              ]);
            }
...
$stts_bayar = $_POST['stts_bayar'];
        ...
        // BUANG FIELD PERTAMA
            ...
            $result = $this->core->db->update('rawat_jl_pr', [
              'nip'=>$nip, 'stts_bayar'=>$stts_bayar
            ], [
              'no_rawat'=>$no_rawat, 'kd_jenis_prw'=>$kd_jenis_prw, 'nip'=>$nip, 'tgl_perawatan'=>$tgl_perawatan, 'jam_rawat'=>$jam_rawat
            ]);

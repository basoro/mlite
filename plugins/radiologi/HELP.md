...
Dokumentasi penggunaan plugin **Radiologi** pada mLITE.

## Deskripsi Singkat

Modul Radiologi untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Radiologi** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Radiologi**.
2. Masuk ke menu **Radiologi** untuk menjalankan proses sesuai alur kerja unit.

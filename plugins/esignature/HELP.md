...
Dokumentasi penggunaan plugin **E-Signature** pada mLITE.

## Deskripsi Singkat

Modul Tanda Tangan Elektronik (TTE) Tersertifikasi

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **E-Signature** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **E-Signature**.
2. Masuk ke menu **E-Signature** untuk menjalankan proses sesuai alur kerja unit.

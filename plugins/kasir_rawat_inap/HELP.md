...
Dokumentasi penggunaan plugin **Kasir Rawat Inap** pada mLITE.

## Deskripsi Singkat

Modul kasir rawat inap untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Kasir Rawat Inap** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Kasir Rawat Inap**.
2. Masuk ke menu **Kasir Rawat Inap** untuk menjalankan proses sesuai alur kerja unit.

-- Seeder dummy Clinical Pathway Stroke Ranap
-- Mencakup:
...
SET @adult_no_rawat = '2026/06/15/000501';
SET @child_no_rawat = '2026/06/15/000502';
SET @adult_rm = '950501';
SET @child_rm = '950502';
SET @adult_cp_code = 'CP-STROKE-RANAP-DWS';
SET @child_cp_code = 'CP-STROKE-RANAP-ANK';
SET @adult_start = '2026-06-15 08:00:00';
SET @child_start = '2026-06-15 09:00:00';
SET @adult_recipe = '260615050101';
SET @child_recipe = '260615050102';
...
SELECT 'I64', 'Stroke, not specified as haemorrhage or infarction', 'Stroke', 'Seeder dummy Clinical Pathway stroke ranap', NULL, 'Menular'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1
  FROM penyakit
  WHERE kd_penyakit = 'I64'
);
...
SELECT 'LABST001', 'Gula Darah Sewaktu', 0, 0, 0, 85000, 0, 0, 0, 85000, '-', '1', 'Kelas 1', 'PK'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM jns_perawatan_lab WHERE kd_jenis_prw = 'LABST001'
);

INSERT INTO jns_perawatan_lab
(kd_jenis_prw, nm_perawatan, bagian_rs, bhp, tarif_perujuk, tarif_tindakan_dokter, tarif_tindakan_petugas, kso, menejemen, total_byr, kd_pj, status, kelas, kategori)
SELECT 'LABST002', 'Profil Koagulasi', 0, 0, 0, 125000, 0, 0, 0, 125000, '-', '1', 'Kelas 1', 'PK'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM jns_perawatan_lab WHERE kd_jenis_prw = 'LABST002'
);
...
SELECT 'RADST001', 'CT Scan Head Non Kontras', 0, 0, 0, 150000, 0, 0, 0, 150000, '-', '1', 'Kelas 1'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM jns_perawatan_radiologi WHERE kd_jenis_prw = 'RADST001'
);
...
VALUES
(
  @adult_rm, 'Hendra Wijaya', '6301000000950501', 'L', 'Barabai', '1990-01-15', 'Siti Aminah',
  'Jl. Murakata No. 20', 'O', 'Wiraswasta', 'MENIKAH', 'ISLAM', '2026-06-15', '081111110201',
  '36 Th', 'SMA', 'ISTRI', 'Siti Badriah', 'UMU', NULL, '1', 1, 1,
  'Ibu Rumah Tangga', 'Jl. Murakata No. 20', '-', '-', '-', '-', 1, 1, 1,
  'hendra.stroke@example.com', '-', 1, '-'
),
(
  @child_rm, 'Yuliana Sari', '6301000000950502', 'P', 'Barabai', '2016-05-12', 'Nurhayati',
  'Jl. Perintis No. 30', 'A', 'Pelajar', 'BELUM MENIKAH', 'ISLAM', '2026-06-15', '082222220202',
  '10 Th', 'SD', 'IBU', 'Nurhayati', 'UMU', NULL, '1', 1, 1,
  'Ibu Rumah Tangga', 'Jl. Perintis No. 30', '-', '-', '-', '-', 1, 1, 1,
  'yuliana.stroke@example.com', '-', 1, '-'
);
...
VALUES
(
  'T00501', @adult_no_rawat, '2026-06-15', '08:00:00', @kd_dokter, @adult_rm, 'UMU',
  'Siti Badriah', 'Jl. Murakata No. 20', 'ISTRI', 0, 'Dirawat', 'Baru', 'Ranap',
  'UMU', 36, 'Th', 'Belum Bayar', 'Baru'
),
(
  'T00502', @child_no_rawat, '2026-06-15', '09:00:00', @kd_dokter, @child_rm, 'UMU',
...
VALUES
(@adult_no_rawat, 'I64', 'Ranap', 1, 'Baru'),
(@child_no_rawat, 'I64', 'Ranap', 1, 'Baru');
...
VALUES
(
  @adult_cp_code, 'Clinical Pathway Stroke Dewasa Ranap', 'Ranap', 4, 3500000, 88.40,
...
(
  @child_cp_code, 'Clinical Pathway Stroke Anak Ranap', 'Ranap', 4, 3000000, 86.75,
...
VALUES
(@adult_cp_id, 'I64', 1, 'Utama'),
(@child_cp_id, 'I64', 1, 'Utama');
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @adult_cp_id AND hari_ke = 1), 'Laboratorium', 'periksa_lab', 'LABST001', 'Gula Darah Sewaktu', 92, 94.00, 'Wajib', 'Ya', 20),
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @adult_cp_id AND hari_ke = 1), 'Laboratorium', 'periksa_lab', 'LABST002', 'Profil Koagulasi', 78, 76.00, 'Direkomendasikan', 'Tidak', 30),
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @adult_cp_id AND hari_ke = 1), 'Obat', 'resep_obat', @kode_obat_sefalosporin, 'Aspilet 80 mg', 88, 89.00, 'Wajib', 'Ya', 50),
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @adult_cp_id AND hari_ke = 2), 'Radiologi', 'periksa_radiologi', 'RADST001', 'CT Scan Head Non Kontras', 54, 52.00, 'Direkomendasikan', 'Tidak', 10),
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @adult_cp_id AND hari_ke = 2), 'Obat', 'resep_obat', @kode_obat_paracetamol, 'Citicoline 500 mg', 84, 86.00, 'Wajib', 'Ya', 20),
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @adult_cp_id AND hari_ke = 3), 'Laboratorium', 'periksa_lab', 'LABST001', 'Evaluasi darah rutin ulang bila perlu', 44, 38.00, 'Opsional', 'Tidak', 10),
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @child_cp_id AND hari_ke = 1), 'Laboratorium', 'periksa_lab', 'LABST001', 'Gula Darah Sewaktu', 88, 90.00, 'Wajib', 'Ya', 20),
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @child_cp_id AND hari_ke = 1), 'Obat', 'resep_obat', @kode_obat_sefalosporin, 'Aspilet 80 mg sesuai berat badan', 86, 88.00, 'Wajib', 'Ya', 40),
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @child_cp_id AND hari_ke = 2), 'Laboratorium', 'periksa_lab', 'LABST002', 'Profil Koagulasi', 72, 74.00, 'Direkomendasikan', 'Tidak', 10),
...
((SELECT id FROM mlite_clinical_pathway_day WHERE clinical_pathway_id = @child_cp_id AND hari_ke = 3), 'Radiologi', 'periksa_radiologi', 'RADST001', 'CT Scan Head Non Kontras', 34, 30.00, 'Opsional', 'Tidak', 10),
...
VALUES
(@adult_no_rawat, 'RI001', @nip_perawat, '2026-06-15', '08:35:00', 0, 0, 25000, 0, 0, 25000),
(@child_no_rawat, 'RI001', @nip_perawat, '2026-06-15', '09:20:00', 0, 0, 25000, 0, 0, 25000);
...
VALUES
(@adult_no_rawat, @nip_perawat, 'LABST001', '2026-06-15', '09:10:00', @kd_dokter, 0, 0, 0, 85000, 0, 0, 0, 85000, @kd_dokter, 'Ranap', 'PK'),
(@adult_no_rawat, @nip_perawat, 'LABST002', '2026-06-15', '09:20:00', @kd_dokter, 0, 0, 0, 125000, 0, 0, 0, 125000, @kd_dokter, 'Ranap', 'PK'),
(@child_no_rawat, @nip_perawat, 'LABST001', '2026-06-15', '10:00:00', @kd_dokter, 0, 0, 0, 85000, 0, 0, 0, 85000, @kd_dokter, 'Ranap', 'PK'),
(@child_no_rawat, @nip_perawat, 'LABST002', '2026-06-13', '08:45:00', @kd_dokter, 0, 0, 0, 125000, 0, 0, 0, 125000, @kd_dokter, 'Ranap', 'PK');
...
VALUES
(@adult_no_rawat, @nip_perawat, 'RADST001', '2026-06-13', '10:15:00', @kd_dokter, 0, 0, 0, 150000, 0, 0, 0, 150000, @kd_dokter, 'Ranap', 'AP', '55', '8', '100', '0', '0', '1', '0.2'),
(@child_no_rawat, @nip_perawat, 'RADST001', '2026-06-14', '09:40:00', @kd_dokter, 0, 0, 0, 150000, 0, 0, 0, 150000, @kd_dokter, 'Ranap', 'AP', '50', '6', '90', '0', '0', '1', '0.1');
...
VALUES
(@adult_recipe, '2026-06-15', '08:45:00', @adult_no_rawat, @kd_dokter, '2026-06-15', '08:45:00', 'ranap', '2026-06-15', '10:00:00'),
(@child_recipe, '2026-06-15', '09:30:00', @child_no_rawat, @kd_dokter, '2026-06-15', '09:30:00', 'ranap', '2026-06-15', '10:30:00');
...
VALUES
(@adult_no_rawat, @adult_cp_id, 'I64', @adult_start, NULL, 'Aktif', 'Ya'),
(@child_no_rawat, @child_cp_id, 'I64', @child_start, NULL, 'Aktif', 'Ya');
...
(
  ...
  'CT Scan Head Non Kontras hari ke-3 tidak dilakukan karena kondisi anak stabil tanpa sesak.',
  'Rendah', NOW(), 'Open'
);
...
VALUES
(@adult_cpp_id, @adult_cp_id, 'seed_generate_cp', @adult_no_rawat, 'Seeder dummy CP stroke ranap dewasa dengan data penunjang lengkap.', 'system', NOW()),
(@child_cpp_id, @child_cp_id, 'seed_generate_cp', @child_no_rawat, 'Seeder dummy CP stroke ranap anak dengan data penunjang lengkap.', 'system', NOW());

...
Dokumentasi penggunaan plugin **Vedika** pada mLITE.

## Deskripsi Singkat

Modul klaim online Vedika BPJS

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Vedika** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Vedika**.
2. Masuk ke menu **Vedika** untuk menjalankan proses sesuai alur kerja unit.

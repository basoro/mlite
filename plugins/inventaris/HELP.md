...
Dokumentasi penggunaan plugin **Inventaris** pada mLITE.
...
2. Buka menu **Inventaris** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Inventaris**.
2. Masuk ke menu **Inventaris** untuk menjalankan proses sesuai alur kerja unit.

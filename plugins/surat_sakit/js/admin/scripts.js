    ...
    $("#lihat_data_mlite_surat_sakit").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                var eTable = "<div class='table-responsive'><table id='tbl_lihat_mlite_surat_sakit' class='table display dataTable' style='width:100%'><thead><th>Id</th><th>Nomor Surat</th><th>No Rawat</th><th>No Rkm Medis</th><th>Nm Pasien</th><th>Tgl Lahir</th><th>Umur</th><th>Jk</th><th>Alamat</th><th>Keadaan</th><th>Diagnosa</th><th>Lama Angka</th><th>Lama Huruf</th><th>Tanggal Mulai</th><th>Tanggal Selesai</th><th>Dokter</th><th>Petugas</th></thead>";

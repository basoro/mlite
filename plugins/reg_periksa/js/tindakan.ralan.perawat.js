...
$('#modal_rawat_jl_pr #kd_jenis_prw').val(kd_jenis_prw).change();
$('#modal_rawat_jl_pr #nip').val(nip).change();
$('#modal_rawat_jl_pr #tgl_perawatan').val(tgl_perawatan);
$('#modal_rawat_jl_pr #jam_rawat').val(jam_rawat);
$('#modal_rawat_jl_pr #material').val(material);
$('#modal_rawat_jl_pr #bhp').val(bhp);
$('#modal_rawat_jl_pr #tarif_tindakanpr').val(tarif_tindakanpr);
$('#modal_rawat_jl_pr #kso').val(kso);
$('#modal_rawat_jl_pr #menejemen').val(menejemen);
$('#modal_rawat_jl_pr #biaya_rawat').val(biaya_rawat);
$('#modal_rawat_jl_pr #stts_bayar').val(stts_bayar).change();

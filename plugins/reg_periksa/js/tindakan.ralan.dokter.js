...
$('#modal_rawat_jl_dr #kd_jenis_prw').val(kd_jenis_prw).change();
$('#modal_rawat_jl_dr #kd_dokter').val(kd_dokter).change();
$('#modal_rawat_jl_dr #tgl_perawatan').val(tgl_perawatan);
$('#modal_rawat_jl_dr #jam_rawat').val(jam_rawat);
$('#modal_rawat_jl_dr #material').val(material);
$('#modal_rawat_jl_dr #bhp').val(bhp);
$('#modal_rawat_jl_dr #tarif_tindakandr').val(tarif_tindakandr);
$('#modal_rawat_jl_dr #kso').val(kso);
$('#modal_rawat_jl_dr #menejemen').val(menejemen);
$('#modal_rawat_jl_dr #biaya_rawat').val(biaya_rawat);
$('#modal_rawat_jl_dr #stts_bayar').val(stts_bayar).change();

...
Dokumentasi penggunaan plugin **Website** pada mLITE.

## Deskripsi Singkat

Membuat website dan berita.

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Website** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Website**.
2. Masuk ke menu **Website** untuk menjalankan proses sesuai alur kerja unit.

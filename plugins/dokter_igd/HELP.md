...
Dokumentasi penggunaan plugin **Dokter IGD** pada mLITE.

## Deskripsi Singkat

Modul dokter IGD untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Dokter IGD** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Dokter IGD**.
2. Masuk ke menu **Dokter IGD** untuk menjalankan proses sesuai alur kerja unit.

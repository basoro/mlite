...
Dokumentasi penggunaan plugin **Sertisign** pada mLITE.

## Deskripsi Singkat

Modul integrasi TTE Sertisign

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Sertisign** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Sertisign**.
2. Masuk ke menu **Sertisign** untuk menjalankan proses sesuai alur kerja unit.

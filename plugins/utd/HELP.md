...
Dokumentasi penggunaan plugin **UTD** pada mLITE.

## Deskripsi Singkat

Modul unit transfusi darah untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **UTD** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **UTD**.
2. Masuk ke menu **UTD** untuk menjalankan proses sesuai alur kerja unit.

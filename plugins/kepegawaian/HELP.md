...
Dokumentasi penggunaan plugin **Kepegawaian** pada mLITE.

## Deskripsi Singkat

Pengelolaan data kepegawaian mLITE.

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Kepegawaian** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Kepegawaian**.
2. Masuk ke menu **Kepegawaian** untuk menjalankan proses sesuai alur kerja unit.

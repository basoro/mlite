...
Dokumentasi penggunaan plugin **Manajemen** pada mLITE.

## Deskripsi Singkat

Modul manajemen untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Manajemen** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Manajemen**.
2. Masuk ke menu **Manajemen** untuk menjalankan proses sesuai alur kerja unit.

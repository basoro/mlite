...
Dokumentasi penggunaan plugin **iCare** pada mLITE.
...
2. Buka menu **iCare** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **iCare**.
2. Masuk ke menu **iCare** untuk menjalankan proses sesuai alur kerja unit.

...
Dokumentasi penggunaan plugin **Oral Diagnostic** pada mLITE.

## Deskripsi Singkat

Modul Oral Diagnostic untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Oral Diagnostic** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Oral Diagnostic**.
2. Masuk ke menu **Oral Diagnostic** untuk menjalankan proses sesuai alur kerja unit.

...
Dokumentasi penggunaan plugin **Laboratorium** pada mLITE.

## Deskripsi Singkat

Modul Laboratorium untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Laboratorium** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Laboratorium**.
2. Masuk ke menu **Laboratorium** untuk menjalankan proses sesuai alur kerja unit.

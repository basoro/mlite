...
Dokumentasi penggunaan plugin **Dokter Ralan** pada mLITE.

## Deskripsi Singkat

Modul dokter rawat jalan untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Dokter Ralan** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Dokter Ralan**.
2. Masuk ke menu **Dokter Ralan** untuk menjalankan proses sesuai alur kerja unit.

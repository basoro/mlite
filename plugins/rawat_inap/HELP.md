...
Dokumentasi penggunaan plugin **Rawat Inap** pada mLITE.

## Deskripsi Singkat

Modul rawat inap untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Rawat Inap** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Rawat Inap**.
2. Masuk ke menu **Rawat Inap** untuk menjalankan proses sesuai alur kerja unit.

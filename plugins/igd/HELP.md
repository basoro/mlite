...
Dokumentasi penggunaan plugin **IGD** pada mLITE.

## Deskripsi Singkat

Modul igd untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **IGD** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **IGD**.
2. Masuk ke menu **IGD** untuk menjalankan proses sesuai alur kerja unit.

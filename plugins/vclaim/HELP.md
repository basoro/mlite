...
Dokumentasi penggunaan plugin **VClaim Request** pada mLITE.

## Deskripsi Singkat

Modul vclaim api untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **VClaim Request** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **VClaim Request**.
2. Masuk ke menu **VClaim Request** untuk menjalankan proses sesuai alur kerja unit.

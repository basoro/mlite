...
Dokumentasi penggunaan plugin **Pendaftaran Pasien** pada mLITE.

## Deskripsi Singkat

Modul data pasien untuk mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Pendaftaran Pasien** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Pendaftaran Pasien**.
2. Masuk ke menu **Pendaftaran Pasien** untuk menjalankan proses sesuai alur kerja unit.

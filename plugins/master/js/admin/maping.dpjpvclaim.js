...
$("#index").on('click', '#bukaform', function(){
  ...
  $("#form").show().load(baseURL + '/master/mapingdpjpvclaimform?t=' + mlite.token);
...
$("#form").on("click", "#simpan", function(event){
  ...
  var kd_dokter_bpjs = $('input:text[name=kd_dokter_bpjs]').val();
  var nm_dokter_bpjs = $('input:text[name=nm_dokter_bpjs]').val();

  var url = baseURL + '/master/mapingdpjpvclaimsave?t=' + mlite.token;
  ...
  $.post(url,{
    ...
    nm_dokter_bpjs: nm_dokter_bpjs
      ...
      $("#display").show().load(baseURL + '/master/mapingdpjpvclaimdisplay?t=' + mlite.token);
      $("#form").hide();
      $("#tutupform").val("Buka Form");
      $("#tutupform").attr("id", "bukaform");
      $('#notif').html("<div class=\"alert alert-success alert-dismissible fade in\" role=\"alert\" style=\"border-radius:0px;margin-top:-15px;\">"+
      "Data mapingdpjpvclaim telah disimpan!"+
...
$("#display").on("click", ".edit", function(event){
  var baseURL = mlite.url + '/' + mlite.admin;
  event.preventDefault();
  var url    = baseURL + '/master/mapingdpjpvclaimform?t=' + mlite.token;
...
$("#form").on("click","#hapus", function(event){
  var baseURL = mlite.url + '/' + mlite.admin;
  event.preventDefault();
  var url = baseURL + '/master/mapingdpjpvclaimhapus?t=' + mlite.token;
  var kd_dokter = $('input:text[name=kd_dokter]').val();
  ...
  bootbox.confirm("Apakah Anda yakin ingin menghapus data ini?", function(result){
    ...
    if (result){
      ...
      $.post(url, {
        ...
        $("#tutupform").val("Buka Form");
        $("#tutupform").attr("id", "bukaform");
        $("#display").load(baseURL + '/master/mapingdpjpvclaimdisplay?t=' + mlite.token);
        $('#notif').html("<div class=\"alert alert-danger alert-dismissible fade in\" role=\"alert\" style=\"border-radius:0px;margin-top:-15px;\">"+
        "Data mapingdpjpvclaim telah dihapus!"+
        "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">&times;</button>"+
        "</div>").show();
      });
    }
...
$('input:text[name=cari]').on('input',function(e){
  var baseURL = mlite.url + '/' + mlite.admin;
  var url    = baseURL + '/master/mapingdpjpvclaimdisplay?t=' + mlite.token;
...
function bersih(){
  ...
  $('input:text[name=nama_mapingdpjpvclaim]').val("");
}

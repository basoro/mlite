...
Dokumentasi penggunaan plugin **Master Data** pada mLITE.

## Deskripsi Singkat

Data master awal mLITE

## Panduan Admin

1. Masuk ke panel admin mLITE dengan akun yang memiliki hak akses pengelolaan modul.
2. Buka menu **Master Data** dari navigasi utama, lalu cek konfigurasi dasar plugin.
...
1. Login menggunakan akun petugas/pengguna yang sudah diberikan akses ke plugin **Master Data**.
2. Masuk ke menu **Master Data** untuk menjalankan proses sesuai alur kerja unit.
